...
funcionales y 21 requisitos no funcionales (RF-26, RF-27, RNF-16 y
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-03 — Entrevista A2, P02 (“no está bien organizado el tema de buscar por nombre y dueño”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-05 — Entrevista A4, P01 (“siempre se caducan por falta de precaución”) y P02.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-07 — Entrevista A3, P01 y P02 (“la parte más demorada”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-08 — Entrevista A3, P02 (“es la parte más demorada”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-10 — Entrevista A6, P02 (“los resultados de exámenes se lo enviamos directamente por WhatsApp”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-11 — Entrevista A5, P02 (“no sabemos qué pasó con el paciente”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-13 — Entrevista B1, P01 (“en base a la edad va a agarrar el peso”) y P02.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-14 — Entrevista B2, P01 (“inculcarle al dueño del perro la alimentación nutritiva adecuada”) y P02.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-15 — Entrevista B3, P02 (“esperamos que lleguen; si no, no podemos saber”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-16 — Entrevista B4, P01 (“se le indica que hay que hacer pruebas de sangre o llevar a una clínica con todos los equipos”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-17 — Entrevista C2/C4, P02 (“si tengo que dar un visto bueno antes, sí”) y P01.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-19 — Bloque C5, P02 (segunda opción) y P01.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-20 — Entrevista D2, P01 (“que sea fácil de usar”) y P02 (“facilidad de utilizarla”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{RNF-21} & Adecuación funcional (Supervisión humana / revocabilidad) & Toda sugerencia del módulo de IA debe poder ser anulada por el médico veterinario en cualquier momento antes de su aplicación clínica, quedando la anulación registrada de forma trazable. & 100\% de las anulaciones registradas con usuario, fecha/hora y motivo, en un plazo máximo de anulación de 24 horas desde que la sugerencia fue emitida; registro no editable ni eliminable (RNF-06). & CU-06 & RST-05, RST-08 \\
\hline
\end{longtable}
}
...
\hline
TR-50 (RNF-18) & EV-01,EV-02 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico \\
\hline
...
\begin{itemize}
  ...
  modelo como medidas equivalentes de explicabilidad.
  ...
  caso único: SGCV-IA se estudió en el contexto organizacional
  específico de una clínica veterinaria en Ecuador, y los stakeholders,
...
\hline
TR-50 & RNF-18 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
...
en Buff Note.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A2 --- P02 ("no está bien organizado el tema de buscar por nombre y dueño")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-04}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A4 --- P01 ("siempre se caducan por falta de precaución"); A4 --- P02
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A3 --- P01; A3 --- P02 ("la parte más demorada")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-08}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A3 --- P02 ("es la parte más demorada")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-09}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A6 --- P02 ("los resultados de exámenes se lo enviamos directamente por
WhatsApp")
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A5 --- P02 ("no sabemos qué pasó con el paciente")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-12}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B1 --- P01 ("en base a la edad va a agarrar el peso"); B1 --- P02
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-14}
...
veterinario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B2 --- P01 ("inculcarle al dueño del perro la alimentación nutritiva
adecuada"); B2 --- P02
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B3 --- P02 ("esperamos que lleguen; si no, no podemos saber")
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-16}
...
equipamiento.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B4 --- P01 ("se le indica que hay que hacer pruebas de sangre o llevar a
...
del veterinario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
C2/C4 --- P02 ("si tengo que dar un visto bueno antes, sí"); C4 --- P01 ("confianza moderada")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-18}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
D2 --- P01 ("que sea fácil de usar"); D2 --- P02 ("facilidad de utilizarla")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-21}
