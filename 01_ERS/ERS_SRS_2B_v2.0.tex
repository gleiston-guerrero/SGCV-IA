...
\textbf{Repositorio:}
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
\url{https://github.com/gleiston-guerrero/SGCV-IA/tree/main}
\end{minipage} \\
\hline
\end{longtable}
}
...
\begin{minipage}[t]{\linewidth}\raggedright
Entrega 4 (2B), cierre del proyecto. Ampliación a 28 requisitos
funcionales y 21 requisitos no funcionales (RF-26 y RF-27 derivados del
análisis de cumplimiento legal LOPDP; RF-28 de gestión de empleados y
permisos, necesidad operativa identificada por el equipo; RNF-16 y
RNF-17 derivados del análisis de cumplimiento legal LOPDP; RNF-18 de
explicabilidad de la IA; RNF-19 de equidad, RNF-20 de monitoreo
posterior al despliegue y RNF-21 de supervisión humana, incorporados
para el componente inteligente), 10 restricciones de diseño (incorporación de
RST-10). Consolidación de la matriz de trazabilidad extendida (63
filas) y de la tabla de priorización MoSCoW/Kano/WSJF en
\texttt{04\_Trazabilidad/}. Bibliografía ampliada a 41 fuentes primarias.
...
\hyperref[tabla-9-bis-interfaces-de-comunicacion]{Tabla 9-bis. Interfaces de comunicación}
...
\hyperref[_bookmarkD1]{Tabla D.1. Matriz de Trazabilidad Extendida --- Identificación normativa y objetivo (87 filas)}

\hyperref[_bookmarkD2]{Tabla D.2. Matriz de Trazabilidad Extendida --- Diseño, historias de usuario y mockup asociado (87 filas)}
...
\begin{quote}
A continuación se describen los canales y protocolos de comunicación
mediante los cuales SGCV-IA intercambia información con servicios
externos. Esta sección complementa la Interfaz de software (Sección
3.1, Tabla 9) enfocándose específicamente en los protocolos de red y
las garantías de seguridad de dichas comunicaciones.
\end{quote}
...
\hline
\endlastfoot
\textbf{API interna del módulo de IA (REST/HTTP)} &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación entre el backend transaccional y el módulo de sugerencia
diagnóstica mediante una API REST sobre HTTP, como componente
desacoplado del núcleo del sistema (RST-04). Ante indisponibilidad del
proveedor externo de IA, el resto del sistema permanece operativo.
\end{minipage} & RF-17, RNF-09, RNF-10, RST-04 \\
\hline
\textbf{Mensajería con propietarios (WhatsApp Business API)} &
\begin{minipage}[t]{\linewidth}\raggedright
Envío de recordatorios de citas y resultados de exámenes a los
propietarios de las mascotas mediante integración con un servicio
externo de mensajería instantánea.
\end{minipage} & RF-10, RF-12 \\
\hline
\textbf{Notificación por correo electrónico} &
\begin{minipage}[t]{\linewidth}\raggedright
Canal alternativo o complementario a WhatsApp para el envío de
recordatorios y comunicaciones con el propietario, cuando no se cuente
con un número de contacto válido para mensajería instantánea.
\end{minipage} & RF-12 \\
\hline
\textbf{Cifrado de comunicaciones externas} &
\begin{minipage}[t]{\linewidth}\raggedright
Toda comunicación con servicios externos (módulo de IA, mensajería,
correo electrónico) debe transmitirse cifrada mediante TLS 1.2 o
superior, conforme al requisito general de confidencialidad en
tránsito del sistema.
\end{minipage} & RNF-12 \\
\hline
\end{longtable}
}

\subparagraph{Tabla 9-bis. Interfaces de
comunicación}\label{tabla-9-bis-interfaces-de-comunicacion}

\begin{quote}
Toda transferencia de datos hacia estos servicios externos (proveedor
de mensajería, motor de IA) debe contar con base de licitud y
garantías contractuales conforme a la LOPDP (RL-11, Sección 3.4).
\end{quote}
...
restricción en la Sección 3.4. RF-25 se vincula al caso de uso
transversal de reportes gerenciales (ver matriz de trazabilidad,
Sección 5).
\end{quote}
...
RC-01 — Entrevista, bloque D3 (P02 y P01).
\end{minipage} \\
\hline
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-02 — Entrevistas A1/A2 (P02; P01).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-03 — Entrevista A2, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-04 — Entrevistas A1 (P02) y A2 (P01).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-05 — Entrevista A4, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-07 — Entrevista A3, P04 (“la parte más demorada”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-08 — Entrevista A3, P04 (“es la parte más demorada”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-10 — Entrevista A6, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-11 — Entrevista A5, P04 (“no sabemos qué pasó con el paciente”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-12 — Entrevista A5 (P02) y A6 (P01).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-13 — Entrevista B1, P05 (“en base a la edad va a agarrar el peso”) y P02.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-14 — Entrevista B2, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-15 — Entrevista B3, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-16 — Entrevista B4, derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-17 — Entrevista C2/C4, P05 (“confianza moderada porque no se parecen los diagnósticos, ya todo es en la práctica, viendo al paciente, viendo en directo”) y P01 (“revisar el texto recomendacional; un área pueda revisar y corregir las sugerencias antes”, cita breve y con redacción imprecisa en la transcripción revisada, pero consistente en el sentido con la exigencia de revisión previa).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-18 — revisado contra las 12 entrevistas que incluyen la pregunta de Bloque C5 (de 16 totales; P01 no fue consultado con esa pregunta). Eligieron explícitamente la opción de literatura científica veterinaria validada: P10 ("una que las recomendaciones estén respaldadas en literatura científica veterinaria validada y que el veterinario pueda revisar y corregir"), P12 ("que las recomendaciones tengan respaldo científico"), P13 ("me iría por la de la literatura... que estén respaldados con literatura, porque estamos hablando de... animalitos, uno no puede dar diagnósticos así por así") y P15 ("la primera, que la recomendación esté respaldada por literatura científica veterinaria validada... le genera un nivel de confianza más allá del medio"). P09 la menciona de forma parcial y ambigua. P02, citado originalmente, no seleccionó esta opción de forma identificable. Se retira la cita original a P01/P02; la reatribución aplicada el 19/09/2026 (commit d17455c) a P11/P14/P15 también resultó incorrecta y fue corregida: la cita queda respaldada por P10, P12, P13 y P15, verificados literalmente contra sus transcripciones (ver \texttt{07\_Datos/registro\_correcciones.md}, Bloque D, D1).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-19 — revisado contra las 12 entrevistas que incluyen la pregunta de Bloque C5 (P01 no fue consultado). Eligieron explícitamente la opción de revisión/corrección por el veterinario: P07 ("la que el veterinario pueda revisar y corregir"), P10, P11, P13 ("elegiría que el veterinario pueda revisar y corregir todas las sugerencias antes de aplicarlas") y P14 ("que el veterinario pueda revisar, modificar o rechazar cualquier sugerencia antes de la aplicación" — coincide casi literalmente con la descripción de RF-19). Se retira la cita a P01/P02 y se sustituye por P07, P10, P11, P13 y P14; el requisito queda además reforzado, de forma independiente, por la exigencia de aprobación explícita ya establecida en RC-17/RF-17.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-20 — Entrevista D2, P01 (“que sea fácil de usar”) y P04 (“facilidad de utilizarla”).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-21 — Entrevista D4, P01 (nivel 2-3/5 de cortes) y P02 (cortes poco frecuentes).
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\subparagraph{RF-28 --- Gestión de empleados y permisos del personal}\label{rf-28-gestion-de-empleados-y-permisos-del-personal}
...
\endlastfoot
\textbf{Nombre} & \begin{minipage}[t]{\linewidth}\raggedright
Gestión de empleados y permisos del personal
\end{minipage} \\
\hline
\textbf{Descripción} & \begin{minipage}[t]{\linewidth}\raggedright
El sistema debe permitir al personal administrativo consultar y modificar la información de los empleados, incluyendo la asignación de roles/permisos y el restablecimiento de contraseñas.
\end{minipage} \\
\hline
\textbf{Caso de Uso} & \begin{minipage}[t]{\linewidth}\raggedright
CU-05
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
Necesidad operativa identificada por el equipo de desarrollo: ningún requisito del catálogo original (Entrega 1B) ni del análisis de cumplimiento legal (Criterio C4) respaldaba a CU-05 (Gestionar Empleados), pese a que el caso de uso ya estaba modelado desde la Sección 4.1. No se elicitó de una entrevista de campo específica.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
Entrada: Datos del empleado a modificar (rol, permisos, contraseña). Salida: Información del empleado actualizada.
\end{minipage} \\
\hline
\textbf{Pre / Postcondiciones} & \begin{minipage}[t]{\linewidth}\raggedright
Pre: El personal administrativo ha iniciado sesión y el empleado está registrado. Post: La información del empleado queda actualizada correctamente.
\end{minipage} \\
\hline
\textbf{Prioridad} & \begin{minipage}[t]{\linewidth}\raggedright
Must have
...
\textbf{Criterio de aceptación} &
\begin{minipage}[t]{\linewidth}\raggedright
El sistema permite modificar rol, permisos y contraseña de un empleado, e informa los errores encontrados sin guardar cambios hasta que se corrijan.
\end{minipage} \\
\hline
\textbf{Dependencias} & \begin{minipage}[t]{\linewidth}\raggedright
Ninguna
...
formalizaron 21 RNF (RNF-01 a RNF-21):
15 de la base técnica (Entrega 1B), RNF-16 y RNF-17 incorporados por el
análisis de cumplimiento legal (criterio C4), RNF-18 correspondiente
a la explicabilidad de las sugerencias del módulo de Inteligencia
Artificial, exigida por la rúbrica (criterio C3). \textbf{Declaración de
origen de RNF-18:} este requisito se incorporó el 01/09/2026, después
de concluida la última entrevista del componente empírico (P16,
31/08/2026); no fue elicitado de forma primaria a partir de las
entrevistas, sino derivado directamente de la exigencia de
explicabilidad del criterio C3 de la rúbrica de evaluación. Los
códigos RC-17, RC-18 y RC-19 que se citan como \emph{Fuente} en su
ficha de requisito (Tabla siguiente) documentan una correspondencia
retrospectiva entre RNF-18 y contenido ya presente en las
transcripciones (percepción de confianza en IA y condiciones para
aceptar una sugerencia), no el origen elicitado del requisito. RNF-18
se clasifica en este documento como \textbf{requisito derivado
(no elicitado)}. El diseño de RNF-18
...
RNF-19 (equidad), RNF-20 (monitoreo posterior al despliegue) y RNF-21
(supervisión humana / revocabilidad) se incorporan en esta versión para
cubrir de forma explícita los requisitos del componente inteligente
exigidos en la Sección 8 de la guía de desarrollo de la Entrega 4 (2B).
\end{quote}
...
\hline
\textbf{RNF-09} & Fiabilidad / Adecuación funcional (Exactitud IA) & Las sugerencias del módulo de IA deben estar respaldadas científicamente, alcanzar una exactitud mínima aceptable frente a un conjunto de prueba clínico, y ser revisables antes de aplicarse. & Exactitud (top-3 diagnóstico incluido entre las sugerencias) $\geq$80\% sobre un conjunto de prueba de al menos 50 casos clínicos anotados por un veterinario independiente; 100\% de sugerencias con referencia bibliográfica y aprobación explícita; generación $\leq$5 segundos. Verificación: evaluación trimestral del conjunto de prueba por el responsable técnico. & CU-06 & RC-17, RC-18, RC-19 \\
\hline
...
\hline
\textbf{RNF-19} & Adecuación funcional (Equidad en el trato) & El módulo de sugerencia diagnóstica no debe presentar diferencias sistemáticas en su tasa de aceptación ni en su exactitud entre subgrupos de pacientes definidos por especie, raza y rango etario. & Diferencia máxima de 10 puntos porcentuales en la tasa de aceptación de la sugerencia entre subgrupos, medida trimestralmente por el responsable técnico sobre un mínimo de 30 casos por subgrupo. & CU-06 & RNF-09, RNF-18 \\
\hline
\textbf{RNF-20} & Fiabilidad (Monitoreo posterior al despliegue) & El sistema debe registrar indicadores operativos del módulo de IA una vez desplegado en producción, permitiendo detectar degradación del servicio o del desempeño del modelo. & Tasa de rechazo de sugerencias, tiempo de respuesta y disponibilidad del proveedor externo, revisados semanalmente por el responsable técnico; alerta automática si la tasa de rechazo supera 40\% en una semana calendario. & CU-06 & RNF-09, RNF-10 \\
\hline
\textbf{RNF-21} & Adecuación funcional (Supervisión humana / revocabilidad) & Toda sugerencia del módulo de IA debe poder ser anulada por el médico veterinario antes de su aplicación clínica y dentro de un plazo máximo de 24 horas desde su emisión, lo que ocurra primero, quedando la anulación registrada de forma trazable. \textbf{(Corrección D4, 20/09/2026: se elimina la contradicción entre "en cualquier momento" y "24 horas"; el plazo de 24 horas es el límite vigente.)} & 100\% de las anulaciones registradas con usuario, fecha/hora y motivo, dentro del plazo máximo de 24 horas desde que la sugerencia fue emitida; registro no editable ni eliminable (RNF-06). & CU-06 & RST-05, RST-08 \\
\hline
\end{longtable}
}
...
Se identificaron 21 RNF, superando el mínimo de 15 exigido por la
rúbrica (criterio C3), y cubriendo explícitamente la explicabilidad de
la IA (RNF-18), la equidad (RNF-19), el monitoreo posterior al
despliegue (RNF-20) y la supervisión humana / revocabilidad (RNF-21)
exigidos en la Sección 8 de la guía de desarrollo de la Entrega 4 (2B).
\end{quote}
...
\subsection{4.1 Diagramas De Casos de Usos} \label{diagramas-casos-de-uso}
...
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio]{./media/CU08_Comunicacion_Cliente.png}
\end{center}
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-01 --- Iniciar Sesión}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Actor principal:} Personal administrativo, Veterinario y
Propietario de la mascota \textbf{Actores secundarios:} Sistema de
Autenticación
...
\textbf{Flujos alternativos:} Flujo alternativo A1: Credenciales incorrectas → el sistema informa el error y permite un nuevo intento, sin bloquear la cuenta. A2: Campos obligatorios vacíos → el sistema solicita completar la información antes de reintentar el envío.
\textbf{Excepciones:} Excepción E1: Condición de disparo: la cuenta del usuario está marcada como inactiva o suspendida. Conducta del sistema: deniega el acceso y no procesa las credenciales, aunque sean correctas. Poscondición: el usuario permanece fuera del sistema y no se genera ninguna sesión.
...
\item
  El sistema actualiza el historial clínico.
\end{enumerate}

\textbf{Flujos alternativos:} Flujo alternativo A1: El veterinario solicita sugerencias de IA → el sistema presenta recomendaciones para apoyar el diagnóstico (deriva a CU-06). Flujo alternativo A2: El veterinario registra un seguimiento nutricional → el sistema almacena la información correspondiente (deriva a CU-07). Flujo alternativo A3: El veterinario registra una comunicación con el dueño → el sistema registra la comunicación en el historial (deriva a CU-08).
\textbf{Excepciones:} Excepción E1: Condición de disparo: la información clínica ingresada es incompleta o inconsistente al intentar guardar. Conducta del sistema: rechaza el guardado y señala los campos faltantes o inválidos. Poscondición: la atención clínica no se registra y el historial del paciente permanece sin modificar.
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-03 --- Revisar Historial Clínico}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
correctamente. \textbf{Flujo principal:}
...
\textbf{Flujos alternativos:} Flujo alternativo A1: El veterinario exporta el historial → el sistema genera el reporte clínico en formato descargable, sin alterar el historial original.
\textbf{Excepciones:} Excepción E1: Condición de disparo: la búsqueda no encuentra un paciente registrado con los criterios ingresados. Conducta del sistema: informa que no se encontraron registros y no muestra información parcial ni de otro paciente. Poscondición: no se muestra ningún historial clínico.
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-04 --- Controlar Inventario}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Actor principal:} Personal administrativo \textbf{Actores secundarios:}
Sistema de Notificaciones \textbf{Precondiciones:} El personal administrativo ha iniciado sesión. \textbf{Postcondiciones (éxito):} El inventario queda actualizado. \textbf{Flujo principal:}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  El personal administrativo accede al módulo de inventario.
\item
  El sistema muestra los productos registrados.
\item
  El personal administrativo registra una entrada o salida de productos.
\item
...
\textbf{Flujos alternativos:} Flujo alternativo A1: Stock mínimo alcanzado tras una salida válida → el sistema registra el movimiento y además genera una alerta de abastecimiento (deriva a CU-09), sin interrumpir la operación.
\textbf{Excepciones:} Excepción E1: Condición de disparo: se intenta registrar una salida de producto por una cantidad mayor al stock disponible. Conducta del sistema: rechaza la operación antes de descontar el stock. Poscondición: el inventario permanece sin cambios y la salida queda sin registrar.
\textbf{Postcondición (fallo):} El inventario permanece sin cambios.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-05 --- Gestionar Empleados}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Actor principal:} Personal administrativo \textbf{Actores secundarios:}
Ninguno \textbf{Precondiciones:} El personal administrativo ha iniciado sesión. \textbf{Postcondiciones (éxito):} La información del empleado queda
actualizada correctamente. \textbf{Flujo principal:}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  El personal administrativo accede al módulo de gestión de personal.
\item
  Selecciona el empleado que desea administrar.
\item
  El sistema muestra la información del empleado.
\item
  El personal administrativo realiza las modificaciones necesarias.
\item
...
\textbf{Flujos alternativos:} Flujo alternativo A1: El personal administrativo asigna permisos al empleado → el sistema actualiza el rol y los permisos correspondientes. Flujo alternativo A2: El personal administrativo restablece la contraseña del empleado → el sistema genera una nueva contraseña temporal o solicita definir una nueva en el siguiente inicio de sesión.
\textbf{Excepciones:} Excepción E1: Condición de disparo: la información ingresada al modificar el empleado es inválida (formato incorrecto, campo obligatorio vacío, rol inexistente). Conducta del sistema: informa los errores encontrados y no guarda ningún campo hasta que se corrijan. Poscondición: los datos del empleado quedan sin modificar.
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-06 --- Generar Sugerencia Diagnóstica con IA}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
formalmente rechazada por el veterinario. \textbf{Flujo principal}
...
\item
  ...
  referencia bibliográfica y nivel de confianza (RNF-09, RNF-18).
\item
...
\textbf{Flujos alternativos:} Flujo alternativo A1: El veterinario rechaza la sugerencia → el sistema registra el rechazo sin incorporar la sugerencia al historial, dejando constancia de que fue evaluada y descartada.
\textbf{Excepciones:} Excepción E1: Condición de disparo: el motor de IA externo no responde dentro del tiempo límite establecido o el servicio está caído. Conducta del sistema: notifica la indisponibilidad y permite continuar la consulta sin sugerencia (RNF-10). Poscondición: la atención clínica puede completarse sin componente de IA; no se registra ninguna sugerencia. Excepción E2: Condición de disparo: el motor de IA responde, pero el nivel de confianza de la sugerencia está por debajo del umbral mínimo definido para el sistema (RNF-09). Conducta del sistema: no presenta la sugerencia como recomendación aplicable, informa al veterinario que el nivel de confianza es insuficiente, y deriva la decisión diagnóstica exclusivamente al criterio del veterinario. Poscondición: no se registra ninguna sugerencia de IA en el historial; la decisión queda documentada como responsabilidad exclusiva del profesional humano.
\textbf{Postcondición (fallo):} Ninguna sugerencia queda registrada sin una acción explícita del veterinario.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-07 --- Registrar Seguimiento Nutricional}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\textbf{Actor principal:} Médico veterinario \textbf{Actores
...
historial de seguimiento y la recomendación nutricional se actualiza. \textbf{Flujo principal}
...
\textbf{Flujos alternativos:} Flujo alternativo A1: Datos insuficientes para generar recomendación → el sistema solicita completar raza, edad o peso antes de continuar, sin descartar los datos ya ingresados.
\textbf{Excepciones:} Excepción E1: Condición de disparo: el módulo de cálculo de recomendaciones nutricionales falla o no está disponible al momento de generar la recomendación. Conducta del sistema: registra el dato de peso, edad y condición corporal en el historial de seguimiento, pero marca la recomendación nutricional como pendiente de generación automática. Poscondición: el seguimiento queda registrado sin recomendación nutricional asociada, disponible para revisión manual posterior.
\textbf{Postcondición (fallo):} El registro de seguimiento no se guarda.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-08 --- Enviar Comunicación y Notificaciones al Cliente}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
historial del paciente con fecha y resumen. \textbf{Flujo principal}
...
\textbf{Flujos alternativos:} Flujo alternativo A1: Falla transitoria del servicio de mensajería externo → el sistema notifica el error y permite reintentar el envío manualmente, sin perder el mensaje redactado.
\textbf{Excepciones:} Excepción E1: Condición de disparo: el servicio de mensajería externo (WhatsApp) permanece no disponible tras los reintentos permitidos. Conducta del sistema: marca la comunicación como no entregada y la deja visible en la ficha del paciente para seguimiento manual por otro medio. Poscondición: la comunicación no queda registrada como enviada, pero sí como intento fallido trazable.
\textbf{Postcondición (fallo):} La comunicación no queda registrada como enviada.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-09 --- Consultar Centro de Notificaciones y Alertas de Inventario}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
atendidas. \textbf{Flujo principal}
...
\textbf{Flujos alternativos:} Flujo alternativo A1: No hay alertas activas → el sistema muestra el centro de notificaciones vacío, sin generar error.
\textbf{Excepciones:} Excepción E1: Condición de disparo: un producto del inventario no tiene fecha de vencimiento registrada, impidiendo calcular su alerta de caducidad. Conducta del sistema: excluye el producto del cálculo automático de alertas y lo marca en el catálogo como pendiente de revisión manual de datos. Poscondición: el producto no genera alertas hasta que se complete su información.
\textbf{Postcondición (fallo):} La alerta permanece activa si no es marcada como atendida.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{CU-10 --- Gestionar Facturación y Cobro}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
cobro registrado. \textbf{Flujo principal}
...
\textbf{Flujos alternativos:} Flujo alternativo A1: Monto incorrecto calculado automáticamente → el personal ajusta manualmente los ítems antes de confirmar, sin reiniciar el proceso de cobro.
\textbf{Excepciones:} Excepción E1: Condición de disparo: el sistema no logra generar el comprobante debido a un error interno tras la confirmación del cobro. Conducta del sistema: registra el cobro como confirmado pero pendiente de comprobante, y notifica al personal administrativo para reintentar la emisión. Poscondición: el cobro queda registrado sin comprobante emitido, trazable para reintento posterior.
\textbf{Postcondición (fallo):} No se emite comprobante y la consulta queda pendiente de cobro.
\end{minipage} \\
\hline
\endhead
\hline
...
\hline
Usuario --- Personal Administrativo & No aplica & Un integrante del
personal administrativo es un tipo de usuario, por lo que hereda sus
...
Usuario. \\
\hline
Propietario --- Paciente & 1: N & Un propietario puede ser dueño de
varias mascotas, mientras que cada paciente pertenece a un único
propietario. \\
\hline
...
\hline
\endlastfoot
Veterinario --- Atención Clínica & 1: N & Un veterinario puede realizar
numerosas atenciones clínicas, mientras que cada atención es realizada
por un único veterinario. \\
\hline
Personal Administrativo --- Inventario & 1: 1 & El personal
administrativo supervisa el inventario del sistema, siendo responsable
de su gestión y actualización. \\
\hline
...
\begin{figure}[H]
    ...
    \caption{Diagrama de actividad de facturación y cobro}
    \label{fig42}
\end{figure}
...
en el documento: 28 Requisitos Funcionales (RF), 21 Requisitos No
Funcionales (RNF), 10 Restricciones (RST) y 14 Requisitos Legales (RL),
para un total de 73 elementos clasificados.
\end{quote}
...
\hline
\endlastfoot
Requisito Funcional (RF) & 28 & RF-01 a RF-28 \\
\hline
Requisito No Funcional (RNF) & 21 & RNF-01 a RNF-21 \\
\hline
Restricción (RST) & 10 & RST-01 a RST-10 \\
\hline
...
de 1 a 3 veterinarios; se priorizará el uso de frameworks, bibliotecas
y servicios de bajo costo o de código abierto.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Presupuestaria)
\end{minipage} \\
\hline
RST-02 & \begin{minipage}[t]{\linewidth}\raggedright
El sistema debe diseñarse con una arquitectura que permita su consumo
equivalente desde aplicaciones móviles (Android/iOS) y desde navegador
de escritorio, sin requerir un rediseño del backend para cada
plataforma.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Tecnológica)
\end{minipage} \\
\hline
RST-03 & \begin{minipage}[t]{\linewidth}\raggedright
El módulo de sincronización offline debe implementarse mediante una
cola local de operaciones pendientes, evitando una réplica completa de
la base de datos en el dispositivo cliente.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Técnica / Hardware)
\end{minipage} \\
\hline
RST-04 & \begin{minipage}[t]{\linewidth}\raggedright
El módulo de Inteligencia Artificial debe implementarse como un
componente desacoplado del backend transaccional principal, de forma
que su indisponibilidad o reentrenamiento no afecte la disponibilidad
del resto del sistema.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Arquitectónica)
\end{minipage} \\
\hline
RST-05 & \begin{minipage}[t]{\linewidth}\raggedright
Toda sugerencia generada por el módulo de IA debe quedar sujeta a
revisión y aprobación explícita del veterinario; el sistema no debe
permitir que una sugerencia se incorpore automáticamente al historial
clínico sin dicha validación.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Ética / Regulatoria)
\end{minipage} \\
\hline
RST-06 & \begin{minipage}[t]{\linewidth}\raggedright
El sistema debe implementar control de acceso basado en roles (RBAC),
restringiendo cada módulo según el perfil del usuario autenticado
(médico veterinario o personal administrativo).
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Seguridad)
\end{minipage} \\
\hline
RST-07 & \begin{minipage}[t]{\linewidth}\raggedright
El registro de auditoría de los historiales clínicos (usuario, fecha,
descripción del cambio) no debe permitir edición ni eliminación
retroactiva.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Seguridad)
\end{minipage} \\
\hline
RST-08 & \begin{minipage}[t]{\linewidth}\raggedright
El sistema no debe emitir diagnósticos definitivos ni prescripciones
automatizadas de medicamentos; toda salida del módulo de IA tiene
carácter de sugerencia sujeta a decisión del veterinario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Regulatoria / Alcance)
\end{minipage} \\
\hline
RST-09 & \begin{minipage}[t]{\linewidth}\raggedright
El sistema no debe integrarse con sistemas gubernamentales de salud
animal ni emitir facturación electrónica certificada ante el SRI en la
versión 1.0.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Regulatoria / Alcance)
\end{minipage} \\
\hline
RST-10 & \begin{minipage}[t]{\linewidth}\raggedright
El equipo responsable del tratamiento debe evaluar, conforme al Art.
48 de la LOPDP, la designación de un Delegado de Protección de Datos
Personales si el volumen o la sensibilidad de los datos tratados lo
amerita.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Sección 3.5 (Regulatoria)
\end{minipage} \\
\hline
\end{longtable}
}
...
\hline
\endlastfoot
Must have & \begin{minipage}[t]{\linewidth}\raggedright
RF-01, RF-02, RF-03, RF-04, RF-05, RF-06, RF-07, RF-08, RF-10, RF-11,
RF-13, RF-16, RF-17, RF-18, RF-19, RF-20, RF-22, RF-23, RF-24, RF-26,
RF-27, RF-28 (22 RF)
\end{minipage} &
\begin{minipage}[t]{\linewidth}\raggedright
RNF-01, RNF-02, RNF-04, RNF-05, RNF-08, RNF-09, RNF-12, RNF-13,
RNF-16, RNF-17, RNF-18, RNF-19, RNF-20, RNF-21 (14 RNF)
...
inventario, gestión de empleados, facturación y comunicación, además
de los requisitos legales de consentimiento y derechos ARCO y los
requisitos del componente de IA (explicabilidad, equidad, monitoreo y
supervisión humana). Sin estos, SGCV-IA no es operable en una clínica
veterinaria real ni cumple con la normativa aplicable. \\
\hline
\textbf{Prioridad} & \textbf{RF} & \textbf{RNF} & \textbf{Justificación
de grupo} \\
\hline
Should have & \begin{minipage}[t]{\linewidth}\raggedright
RF-09, RF-12, RF-14, RF-15, RF-21 (5 RF)
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
RNF-03, RNF-06, RNF-07, RNF-11, RNF-15 (5 RNF)
\end{minipage} & Aportan valor significativo (comunicación post-consulta,
recordatorios automáticos, seguimiento nutricional, trazabilidad de
auditoría, operación offline, interoperabilidad, usabilidad extendida)
pero el sistema es funcional sin ellos en una primera versión; pueden
incorporarse en una segunda iteración sin bloquear la operación diaria. \\
\hline
\textbf{Prioridad} & \textbf{RF} & \textbf{RNF} & \textbf{Justificación
de grupo} \\
\hline
Could have & \begin{minipage}[t]{\linewidth}\raggedright
RF-25 (1 RF)
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
RNF-10, RNF-14 (2 RNF)
\end{minipage} & El panel de reportes gerenciales (RF-25) es un valor
complementario y no bloqueante para la operación. A nivel de RNF, la
resiliencia total ante una caída prolongada del proveedor externo de
IA (RNF-10) y un requisito de calidad interna de bajo impacto
(RNF-14) son mejoras deseables que no bloquean la operación básica
del sistema; se abordan en una segunda iteración. \\
\hline
\end{longtable}
}
...
\textbf{Resumen cuantitativo (RF):} 22 Must (79\%), 5 Should (18\%), 1
Could (4\%), 0 Won\textquotesingle t --- sobre el 60\% recomendado por
la regla general de MoSCoW en Must have; se justifica por el peso de
los requisitos legales (LOPDP) y del componente de IA, que son de
cumplimiento obligatorio en el contexto de esta entrega. \textbf{Resumen
cuantitativo (RNF):} 14 Must (67\%), 5 Should (24\%), 2 Could (9\%).
\end{quote}
...
Apéndice B (EV-01: entrevista a P01, 24/05/2026; EV-02:
entrevista a P02, 25/05/2026; EV-03: acta de reunión firmada; EV-04:
...
legales derivados de la LOPDP (Sección 3.4), RF-27 corresponde al
portal de seguimiento de derechos ARCO derivado de la misma norma, y
RNF-18 corresponde al requisito de explicabilidad de la IA.
\end{quote}
...
\hline
\endlastfoot
RF-01 & RF & Must & Desempeño & Alto & --- & CU-01 &
\begin{minipage}[t]{\linewidth}\raggedright
Todas las pantallas\\
(responsive)\strut
\end{minipage} \\
\hline
RF-02 & RF & Must & Básico & Alto & --- & CU-03 &
\begin{minipage}[t]{\linewidth}\raggedright
Gestión de\\
...
\end{minipage} \\
\hline
RF-07 & RF & Must & Básico & Alto & --- & CU-10 &
\begin{minipage}[t]{\linewidth}\raggedright
Facturación y\\
Cobro\strut
\end{minipage} \\
\hline
RF-08 & RF & Must & Atractivo & Alto & --- & CU-10 &
\begin{minipage}[t]{\linewidth}\raggedright
Facturación y\\
Cobro\strut
\end{minipage} \\
...
\end{minipage} \\
\hline
RF-25 & RF & Could & Atractivo & Medio & --- & Transversal &
\begin{minipage}[t]{\linewidth}\raggedright
Reportes\\
Gerenciales\strut
\end{minipage} \\
...
Formulario de\\
Solicitud ARCO\strut
\end{minipage} \\
\hline
RF-27 & RF & Must & Básico & Alto &
\begin{minipage}[t]{\linewidth}\raggedright
LOPDP Art. 12--15\strut
\end{minipage} & CU-01 & \begin{minipage}[t]{\linewidth}\raggedright
Portal de\\
...
\end{minipage} \\
\hline
RF-28 & RF & Must & Básico & Alto &
\begin{minipage}[t]{\linewidth}\raggedright
---\strut
\end{minipage} & CU-05 & \begin{minipage}[t]{\linewidth}\raggedright
Gestión de\\
Personal\strut
\end{minipage} \\
\hline
...
& Transversal \\
\hline
RNF-16 & RNF & Must & Básico & Alto & LOPDP Art. 10 lit. i) & Transversal & Transversal \\
\hline
RNF-17 & RNF & Must & Básico & Alto & LOPDP Art. 43, 46 & Transversal & Transversal \\
\hline
RNF-18 & RNF & Must & Atractivo & Alto &
\begin{minipage}[t]{\linewidth}\raggedright
RST-05\\
...
\end{minipage} \\
\hline
RNF-19 & RNF & Must & Básico & Alto & --- & CU-06 & \begin{minipage}[t]{\linewidth}\raggedright
Panel de\\
Diagnóstico IA\strut
\end{minipage} \\
\hline
RNF-20 & RNF & Must & Básico & Alto & --- & CU-06 & \begin{minipage}[t]{\linewidth}\raggedright
Panel de\\
Diagnóstico IA\strut
\end{minipage} \\
\hline
RNF-21 & RNF & Must & Básico & Alto &
\begin{minipage}[t]{\linewidth}\raggedright
RST-05, RST-08\\
(supervisión humana)\strut
\end{minipage} & CU-06 & \begin{minipage}[t]{\linewidth}\raggedright
Panel de\\
Diagnóstico IA\strut
\end{minipage} \\
...
\end{minipage} \\
\hline
RST-07 & RST & N/A & N/A & Alto & LOPDP Art. 4 & CU-03 & No aplica \\
\hline
RST-08 & RST & N/A & N/A & Alto & --- & CU-06 & \begin{minipage}[t]{\linewidth}\raggedright
Panel de\\
Diagnóstico IA\strut
\end{minipage} \\
\hline
RST-09 & RST & N/A & N/A & Medio & --- & --- & No aplica \\
\hline
RST-10 & RST & N/A & N/A & Alto & LOPDP Art. 47, 48 & Transversal & No aplica \\
\hline
\end{longtable}
}
...
\hline
EV-01 & \begin{minipage}[t]{\linewidth}\raggedright
RF-03 --- Búsqueda rápida por nombre del paciente y del dueño
\end{minipage} & CU-03 Historial Clínico \\
\hline
EV-01 & \begin{minipage}[t]{\linewidth}\raggedright
RF-04 --- Registro detallado de historial clínico
...
\end{minipage} & CU-04 Controlar Inventario \\
\hline
EV-01, EV-02 & \begin{minipage}[t]{\linewidth}\raggedright
...
\end{minipage} & CU-10 Facturación y Cobro \\
\hline
EV-02 & \begin{minipage}[t]{\linewidth}\raggedright
RF-08 --- Facturación ágil
\end{minipage} & CU-10 Facturación y Cobro \\
\hline
EV-01 & \begin{minipage}[t]{\linewidth}\raggedright
...
\subsection{5.3 Historias de Usuarios} \label{historias-de-usuario}
...
\subparagraph{HU-15 --- RF-27}
\textbf{Como} propietario de la mascota,
\textbf{quiero} acceder a un portal donde pueda ver el estado de mi solicitud de derechos ARCO,
\textbf{para} confirmar que fue recibida y conocer el plazo de respuesta pendiente.

\begin{quote}
\textbf{CA-15 (Gherkin).} \\
Dado que un titular ha registrado una solicitud ARCO a través del portal, \\
Cuando consulta el estado de su solicitud, \\
Entonces el sistema muestra la fecha de recepción, el plazo restante y el estado actual (pendiente/atendida).
\end{quote}
...
\begin{quote}
\textbf{CA-31 (Gherkin) --- RNF-18, corrección D4 (20/09/2026).} CA-16
cubre el respaldo bibliográfico (RF-18), no la explicabilidad
(RNF-18); se define aquí un criterio propio para RNF-18, antes citado
erróneamente con CA-16 en la matriz de trazabilidad (TR-50). \\
Dado que el módulo de IA genera una sugerencia diagnóstica, \\
Cuando la presenta al veterinario, \\
Entonces muestra al menos 3 factores clínicos de mayor peso y un
indicador de confianza (alto/medio/bajo), en lenguaje comprensible sin
conocimientos técnicos, antes de que el veterinario pueda decidir.
\end{quote}
...
\subparagraph{HU-21 --- RF-12}
\textbf{Como} propietario de la mascota,
\textbf{quiero} recibir un recordatorio automático 24 horas antes de mi cita,
\textbf{para} no olvidar la consulta programada.

\begin{quote}
\textbf{CA-21 (Gherkin).} \\
Dado que existe una cita programada para un paciente, \\
Cuando faltan 24 horas para la hora de la cita, \\
Entonces el sistema envía el recordatorio automáticamente, sin intervención manual.
\end{quote}

\subparagraph{HU-22 --- RF-14}
\textbf{Como} médico veterinario,
\textbf{quiero} recibir recomendaciones nutricionales automáticas basadas en el peso y condición del paciente,
\textbf{para} orientar mejor al propietario sobre su alimentación.

\begin{quote}
\textbf{CA-22 (Gherkin).} \\
Dado que se registra un nuevo dato de peso o condición corporal (RF-13), \\
Cuando el registro se guarda, \\
Entonces la recomendación nutricional se actualiza automáticamente.
\end{quote}

\subparagraph{HU-23 --- RF-15}
\textbf{Como} médico veterinario,
\textbf{quiero} programar recordatorios de seguimiento de indicaciones médicas,
\textbf{para} verificar que el propietario cumpla con el tratamiento indicado.

\begin{quote}
\textbf{CA-23 (Gherkin).} \\
Dado que el veterinario programa un recordatorio con fecha y descripción, \\
Cuando llega la fecha establecida, \\
Entonces el sistema notifica al personal correspondiente.
\end{quote}

\subparagraph{HU-24 --- RF-16}
\textbf{Como} médico veterinario,
\textbf{quiero} exportar el historial clínico del paciente en PDF,
\textbf{para} remitirlo a clínicas con mayor equipamiento cuando sea necesario.

\begin{quote}
\textbf{CA-24 (Gherkin).} \\
Dado que el veterinario solicita la exportación del historial de un paciente, \\
Cuando confirma la solicitud, \\
Entonces el sistema genera un PDF completo del historial, descargable en menos de 5 segundos.
\end{quote}

\subparagraph{HU-25 --- RF-21}
\textbf{Como} médico veterinario,
\textbf{quiero} seguir registrando y consultando historiales clínicos aunque no haya conexión a internet,
\textbf{para} no interrumpir la atención durante cortes de conectividad.

\begin{quote}
\textbf{CA-25 (Gherkin).} \\
Dado que se pierde la conexión a internet durante la atención, \\
Cuando el veterinario registra o consulta un historial clínico, \\
Entonces el registro y consulta permanecen disponibles sin conexión, y la sincronización se completa según RNF-04 al restablecerse la conectividad.
\end{quote}

\subparagraph{HU-26 --- RF-23}
\textbf{Como} administrador del sistema,
\textbf{quiero} que cada modificación a un historial clínico quede registrada con usuario, fecha y descripción,
\textbf{para} auditar cambios y cumplir con la trazabilidad exigida por la LOPDP.

\begin{quote}
\textbf{CA-26 (Gherkin).} \\
Dado que se modifica un historial clínico, \\
Cuando el cambio se guarda, \\
Entonces el sistema genera un registro de auditoría (usuario, fecha, descripción) que no puede editarse ni eliminarse retroactivamente, conforme a RNF-06.
\end{quote}

\subparagraph{HU-27 --- RF-25}
\textbf{Como} propietario o administrador de la clínica,
\textbf{quiero} un panel de reportes gerenciales y estadísticas operativas,
\textbf{para} tomar decisiones informadas sobre el negocio.

\begin{quote}
\textbf{CA-27 (Gherkin).} \\
Dado que el propietario o administrador accede al panel de reportes, \\
Cuando selecciona un rango de fechas o indicador, \\
Entonces el sistema muestra las estadísticas operativas correspondientes.
\end{quote}
\subparagraph{HU-28 --- RNF-19}
\textbf{Como} responsable técnico,
\textbf{quiero} revisar trimestralmente la tasa de aceptación y exactitud del módulo de IA por subgrupo de especie, raza y rango etario,
\textbf{para} detectar y corregir diferencias sistemáticas de trato antes de que afecten a un grupo de pacientes.

\begin{quote}
\textbf{CA-28 (Gherkin).} \\
Dado el reporte trimestral de desempeño del módulo de IA por subgrupo, \\
Cuando la diferencia en la tasa de aceptación entre subgrupos supera 10 puntos porcentuales sobre un mínimo de 30 casos por subgrupo, \\
Entonces el sistema señala la desviación al responsable técnico para su revisión antes del siguiente ciclo de uso clínico.
\end{quote}

\subparagraph{HU-29 --- RNF-20}
\textbf{Como} responsable técnico,
\textbf{quiero} revisar semanalmente los indicadores operativos del módulo de IA (tasa de rechazo, tiempo de respuesta, disponibilidad del proveedor),
\textbf{para} detectar degradación del servicio o del modelo tras su despliegue en producción.

\begin{quote}
\textbf{CA-29 (Gherkin).} \\
Dado el registro semanal de indicadores operativos del módulo de IA, \\
Cuando la tasa de rechazo de sugerencias supera 40\% en una semana calendario, \\
Entonces el sistema genera una alerta automática dirigida al responsable técnico.
\end{quote}

\subparagraph{HU-30 --- RF-28}
\textbf{Como} personal administrativo,
\textbf{quiero} consultar y modificar la información de los empleados (roles, permisos, contraseñas),
\textbf{para} mantener actualizados los accesos del equipo sin depender de otro perfil.

\begin{quote}
\textbf{CA-30 (Gherkin).} \\
Dado que el personal administrativo modifica los datos de un empleado, \\
Cuando la información ingresada es inválida (formato incorrecto, campo obligatorio vacío, rol inexistente), \\
Entonces el sistema informa los errores encontrados y no guarda ningún cambio hasta que se corrijan.
\end{quote}
...
legibilidad, cubriendo el total de 87 filas de trazabilidad (TR-01 a
TR-87), correspondientes a 28 RF, 21 RNF y 10 RST, sobre el
...
\hline
\endlastfoot
TR-01 (RF-01) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-02 (RF-02) & RF & LOPDP & Art. 14 & OE-01 & Médico veterinario \\
\hline
TR-03 (RF-02) & RF & LOPDP & Art. 14 & OE-01 & Médico veterinario \\
\hline
TR-04 (RF-03) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-05 (RF-04) & RF & LOPDP & Art. 4 & OE-01 & Médico veterinario \\
\hline
TR-06 (RF-05) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-07 (RF-06) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-08 (RF-06) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-09 (RF-07) & RF & LOPDP & Art. 10 lit. e) & OE-03 & Personal administrativo \\
\hline
TR-10 (RF-08) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-11 (RF-09) & RF & LOPDP & Art. 4 & OE-03 & Propietario de la mascota \\
\hline
TR-12 (RF-10) & RF & LOPDP & Art. 4 & OE-03 & Propietario de la mascota \\
\hline
TR-13 (RF-11) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-14 (RF-11) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-15 (RF-12) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-16 (RF-13) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-17 (RF-14) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-18 (RF-15) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-19 (RF-16) & RF & LOPDP & Art. 17 & OE-01 & Médico veterinario \\
\hline
TR-20 (RF-17) & RF & LOPDP & Art. 20, Art. 25/26/30/31 & OE-02 & Médico veterinario \\
\hline
TR-21 (RF-17) & RF & LOPDP & Art. 20, Art. 25/26/30/31 & OE-02 & Médico veterinario \\
\hline
TR-22 (RF-18) & RF & LOPDP & Art. 20 & OE-02 & Médico veterinario \\
\hline
TR-23 (RF-18) & RF & LOPDP & Art. 20 & OE-02 & Médico veterinario \\
\hline
TR-24 (RF-19) & RF & LOPDP & Art. 20 & OE-02 & Médico veterinario \\
\hline
TR-25 (RF-20) & RF & — & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-26 (RF-21) & RF & — & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-27 (RF-22) & RF & LOPDP & Art. 4 & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-28 (RF-23) & RF & LOPDP & Art. 4 (auditoría) & OE-01 & Médico veterinario \\
\hline
TR-29 (RF-24) & RF & — & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-30 (RF-25) & RF & — & — & OE-03 & Propietario o administrador de la clínica \\
\hline
TR-31 (RF-26) & RF & LOPDP & Art. 7, 8 & Transversal (LOPDP) & Propietario de la mascota \\
\hline
TR-32 (RF-27) & RF & LOPDP & Art. 12-15 & Transversal (LOPDP) & Propietario de la mascota \\
\hline
TR-33 (RNF-01) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-34 (RNF-02) & RNF & ISO/IEC 25010 & — & OE-03 & Personal administrativo \\
\hline
TR-35 (RNF-03) & RNF & ISO/IEC 25010 & — & OE-03 & Personal administrativo \\
\hline
TR-36 (RNF-04) & RNF & ISO/IEC 25010 & — & OE-01 & Médico veterinario \\
\hline
TR-37 (RNF-05) & RNF & LOPDP + ISO/IEC 25010 & Art. 4 & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-38 (RNF-06) & RNF & LOPDP & Art. 4 & OE-01 & Médico veterinario \\
\hline
TR-39 (RNF-07) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Personal administrativo \\
\hline
TR-40 (RNF-08) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-41 (RNF-09) & RNF & ISO/IEC 25010 + LOPDP & Art. 25/26/30/31 & OE-02 & Médico veterinario \\
\hline
TR-42 (RNF-10) & RNF & ISO/IEC 25010 + LOPDP & Art. 33/34/35 & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-43 (RNF-11) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-44 (RNF-12) & RNF & ISO/IEC 25010 + LOPDP & Art. 25/26/30/31, Art. 37/39 & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-45 (RNF-13) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-46 (RNF-14) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo \\
\hline
TR-47 (RNF-15) & RNF & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Personal administrativo \\
\hline
TR-48 (RNF-16) & RNF & LOPDP & Art. 10 lit. i) & Transversal (LOPDP) & Comité de ética / protección de datos (LOPDP) \\
\hline
TR-49 (RNF-17) & RNF & LOPDP & Art. 43, 46 & Transversal (LOPDP) & Comité de ética / protección de datos (LOPDP) \\
\hline
TR-50 (RNF-18) & RNF & LOPDP & Art. 20 & OE-02 & Médico veterinario \\
\hline
TR-51 (RST-01) & RST & — & — & Transversal & Equipo de desarrollo \\
\hline
TR-52 (RST-02) & RST & — & — & Transversal & Equipo de desarrollo \\
\hline
TR-53 (RST-03) & RST & — & — & Transversal & Equipo de desarrollo \\
\hline
TR-54 (RST-04) & RST & — & — & OE-02 & Equipo de desarrollo \\
\hline
TR-55 (RST-05) & RST & LOPDP & Art. 20 & OE-02 & Equipo de desarrollo \\
\hline
TR-56 (RST-06) & RST & — & — & Transversal & Equipo de desarrollo \\
\hline
TR-57 (RST-07) & RST & LOPDP & Art. 4 & OE-01 & Equipo de desarrollo \\
\hline
TR-58 (RST-08) & RST & LOPDP & Art. 20 & OE-02 & Equipo de desarrollo \\
\hline
TR-59 (RST-09) & RST & — & Sec. 1.2 & Transversal & Equipo de desarrollo \\
\hline
TR-60 (RST-10) & RST & LOPDP & Art. 47, 48 & Transversal (LOPDP) & Comité de ética / protección de datos (LOPDP) \\
\hline
TR-61 (RNF-19) & RNF & — & — & OE-02 & Equipo de desarrollo \\
\hline
TR-62 (RNF-20) & RNF & — & — & OE-02 & Equipo de desarrollo \\
\hline
TR-63 (RNF-21) & RNF & — & RST-05, RST-08 (supervisión humana) & OE-02 & Médico veterinario \\
\hline
TR-64 (N/A (evento de flujo)) & — & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario \\
\hline
TR-65 (N/A (evento de flujo)) & — & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario \\
\hline
TR-66 (N/A (evento de flujo)) & — & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario \\
\hline
TR-67 (RF-04) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-68 (RF-04) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-69 (RF-04) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-70 (RF-04) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-71 (RF-16) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-72 (RF-02) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-73 (RF-05) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-74 (RF-06) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-75 (RF-28) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-76 (RF-28) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-77 (RF-28) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-78 (RF-28) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-79 (RF-17) & RF & — & — & OE-02 & Médico veterinario \\
\hline
TR-80 (RF-13) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-81 (RF-14) & RF & — & — & OE-01 & Médico veterinario \\
\hline
TR-82 (RF-09) & RF & — & — & OE-03 & Propietario de la mascota \\
\hline
TR-83 (RF-10) & RF & — & — & OE-03 & Propietario de la mascota \\
\hline
TR-84 (RF-06) & RF & — & — & OE-03 & Personal administrativo / Bodeguero \\
\hline
TR-85 (RF-05) & RF & — & — & OE-03 & Personal administrativo / Bodeguero \\
\hline
TR-86 (RF-08) & RF & — & — & OE-03 & Personal administrativo \\
\hline
TR-87 (RF-08) & RF & — & — & OE-03 & Personal administrativo \\
\hline
\end{longtable}
}
...
Trazabilidad Extendida --- Tabla A: identificación, normativa y objetivo (corregida a partir de matriz\_trazabilidad.csv).}}
\end{quote}

\subsubsection{5.4.2. Tabla B --- Trazabilidad de diseño}\label{matriz-extendida-tabla-b}

\begin{quote}
\textbf{Nota sobre TR-50 (RNF-18):} la columna ID-EV de esta fila
(EV-01, EV-02) documenta una correspondencia retrospectiva con
contenido de entrevistas ya existente, no el origen elicitado del
requisito. RNF-18 es un \textbf{requisito derivado (no elicitado)},
incorporado el 01/09/2026 por exigencia directa del criterio C3 de la
rúbrica, después de concluida la última entrevista (P16, 31/08/2026).
Ver declaración completa en la Sección 3.3.

\textbf{Nota sobre el mockup MU-010\_Sugerencia\_IA (corrección D5,
20/09/2026):} el encabezado de la imagen
(\texttt{03\_Modelado/Mockups/MU-010\_Sugerencia\_IA.png}) rotula la
pantalla como "RF-17 · RF-18 · RF-19 · RNF-09" y no incluye RNF-18. El
contenido visual muestra un porcentaje de confianza por diagnóstico
(82\%/11\%/7\%) y una justificación en prosa con algunos factores
clínicos, pero no en el formato que exige el criterio de aceptación de
RNF-18 (indicador de confianza discreto alto/medio/bajo, y al menos 3
factores clínicos identificados explícitamente, no en párrafo). Se
declara aquí como \textbf{brecha de implementación de RNF-18 en el
mockup}, no como requisito satisfecho; no se edita la imagen para
evitar fabricar evidencia visual no verificada por el equipo.
\end{quote}
...
\hline
\endlastfoot
TR-01 (RF-01) & EV-01 & CU-01 & HU-01 & CA-01 & Frontend Web/Móvil \\
\hline
TR-02 (RF-02) & EV-01 & CU-03 & HU-02 & CA-02 & Backend Historiales Clínicos \\
\hline
TR-03 (RF-02) & EV-02 & CU-03 & HU-02 & CA-02 & Backend Historiales Clínicos \\
\hline
TR-04 (RF-03) & EV-01 & CU-03 & HU-03 & CA-03 & Backend Historiales Clínicos \\
\hline
TR-05 (RF-04) & EV-01 & CU-02 & HU-04 & CA-04 & Backend Historiales Clínicos \\
\hline
TR-06 (RF-05) & EV-02 & CU-04 & HU-05 & CA-05 & Backend Inventario \\
\hline
TR-07 (RF-06) & EV-01 & CU-04 & HU-06 & CA-06 & Backend Inventario \\
\hline
TR-08 (RF-06) & EV-02 & CU-04 & HU-06 & CA-06 & Backend Inventario \\
\hline
TR-09 (RF-07) & EV-02 & CU-10 & HU-07 & CA-07 & Backend Facturación \\
\hline
TR-10 (RF-08) & EV-02 & CU-10 & HU-08 & CA-08 & Backend Facturación \\
\hline
TR-11 (RF-09) & EV-01 & CU-08 & HU-09 & CA-09 & Módulo Comunicaciones \\
\hline
TR-12 (RF-10) & EV-02 & CU-08 & HU-10 & CA-10 & Módulo Comunicaciones \\
\hline
TR-13 (RF-11) & EV-01 & CU-09 & HU-11 & CA-11 & Módulo Citas y Recordatorios \\
\hline
TR-14 (RF-11) & EV-02 & CU-09 & HU-11 & CA-11 & Módulo Citas y Recordatorios \\
\hline
TR-15 (RF-12) & EV-02 & CU-09 & HU-22 — Como propietario de la mascota, quiero recibir un recordatorio automático 24 horas antes de mi cita, para no olvidar la consulta programada. & El recordatorio se envía automáticamente 24 horas antes de la cita, sin intervención manual. & Módulo Citas y Recordatorios \\
\hline
TR-16 (RF-13) & EV-01 & CU-07 & HU-12 & CA-12 & Backend Seguimiento Nutricional \\
\hline
TR-17 (RF-14) & EV-01 & CU-07 & HU-23 — Como médico veterinario, quiero recibir recomendaciones nutricionales automáticas basadas en el peso y condición del paciente, para orientar mejor al propietario sobre su alimentación. & La recomendación se actualiza automáticamente al registrarse un nuevo dato de peso o condición corporal (RF-13). & Backend Seguimiento Nutricional \\
\hline
TR-18 (RF-15) & EV-02 & CU-09 & HU-24 — Como médico veterinario, quiero programar recordatorios de seguimiento de indicaciones médicas, para verificar que el propietario cumpla con el tratamiento indicado. & El veterinario puede programar un recordatorio con fecha y descripción el sistema notifica al personal en la fecha establecida. & Módulo Citas y Recordatorios \\
\hline
TR-19 (RF-16) & EV-01 & CU-03 & HU-25 — Como médico veterinario, quiero exportar el historial clínico del paciente en PDF, para remitirlo a clínicas con mayor equipamiento cuando sea necesario. & El sistema genera un PDF con el historial clínico completo del paciente, descargable en menos de 5 segundos. & Backend Historiales Clínicos \\
\hline
TR-20 (RF-17) & EV-01 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico \\
\hline
TR-21 (RF-17) & EV-02 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico \\
\hline
TR-22 (RF-18) & EV-01 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico \\
\hline
TR-23 (RF-18) & EV-02 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico \\
\hline
TR-24 (RF-19) & EV-01,EV-02 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico \\
\hline
TR-25 (RF-20) & EV-01,EV-02 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil \\
\hline
TR-26 (RF-21) & EV-01,EV-02 & Transversal & HU-26 — Como médico veterinario, quiero seguir registrando y consultando historiales clínicos aunque no haya conexión a internet, para no interrumpir la atención durante cortes de conectividad. & El registro y consulta permanecen disponibles sin conexión la sincronización se completa según RNF-04 al restablecerse la conectividad. & Infraestructura/Backend \\
\hline
TR-27 (RF-22) & EV-01,EV-02 & CU-01 & HU-19 & CA-19 & Módulo Autenticación/Usuarios \\
\hline
TR-28 (RF-23) & EV-02 & CU-03 & HU-27 — Como administrador del sistema, quiero que cada modificación a un historial clínico quede registrada con usuario, fecha y descripción, para auditar cambios y cumplir con la trazabilidad exigida por la LOPDP. & Toda modificación genera un registro de auditoría (usuario, fecha, descripción) que no puede editarse ni eliminarse retroactivamente, conforme a RNF-06. & Backend Historiales Clínicos \\
\hline
TR-29 (RF-24) & EV-04 & CU-01 & HU-20 & CA-20 & Módulo Autenticación/Usuarios \\
\hline
TR-30 (RF-25) & — & Transversal & HU-21 & CA-21 & Backend Reportes \\
\hline
TR-31 (RF-26) & EV-04 & Transversal & HU-14 & CA-14 & Módulo Legal/Consentimiento \\
\hline
TR-32 (RF-27) & EV-04 & Transversal & HU-15 & CA-15 & Módulo Legal/Consentimiento \\
\hline
TR-33 (RNF-01) & EV-02 & CU-03 & HU-03 & CA-03 & Backend Historiales Clínicos \\
\hline
TR-34 (RNF-02) & EV-02 & CU-10 & HU-08 & CA-08 & Backend Facturación \\
\hline
TR-35 (RNF-03) & EV-01,EV-02 & CU-04 & HU-05 & CA-05 & Backend Inventario \\
\hline
TR-36 (RNF-04) & EV-01,EV-02 & CU-03 & HU-26 & CA-26 & Backend Historiales Clínicos \\
\hline
TR-37 (RNF-05) & EV-01,EV-02 & CU-01 & HU-20 & CA-20 & Módulo Autenticación/Usuarios \\
\hline
TR-38 (RNF-06) & EV-01,EV-02 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos \\
\hline
TR-39 (RNF-07) & EV-01,EV-02 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil \\
\hline
TR-40 (RNF-08) & EV-01,EV-02 & Transversal & HU-01 & CA-01 & Frontend Web/Móvil \\
\hline
TR-41 (RNF-09) & EV-01,EV-02 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico \\
\hline
TR-42 (RNF-10) & — & CU-06 & — & — & Módulo IA Diagnóstico \\
\hline
TR-43 (RNF-11) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-44 (RNF-12) & EV-02 & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-45 (RNF-13) & EV-14,EV-16 & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-46 (RNF-14) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-47 (RNF-15) & EV-07,EV-13,EV-18 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil \\
\hline
TR-48 (RNF-16) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-49 (RNF-17) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-50 (RNF-18) & EV-01,EV-02 & CU-06 & HU-16 & CA-31 & Módulo IA Diagnóstico \\
\hline
TR-51 (RST-01) & EV-01 & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-52 (RST-02) & EV-05,EV-18 & CU-01 & HU-01 & CA-01 & Módulo Autenticación/Usuarios \\
\hline
TR-53 (RST-03) & EV-15,EV-16 & Transversal & HU-26 & CA-26 & Infraestructura/Backend \\
\hline
TR-54 (RST-04) & — & CU-06 & — & — & Módulo IA Diagnóstico \\
\hline
TR-55 (RST-05) & EV-01,EV-14,EV-17 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico \\
\hline
TR-56 (RST-06) & EV-14,EV-16 & CU-01 & HU-19 & CA-19 & Módulo Autenticación/Usuarios \\
\hline
TR-57 (RST-07) & EV-12 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos \\
\hline
TR-58 (RST-08) & EV-01,EV-02,EV-13 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico \\
\hline
TR-59 (RST-09) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-60 (RST-10) & — & Transversal & — & — & Infraestructura/Backend \\
\hline
TR-61 (RNF-19) & — & CU-06 & HU-28 & CA-28 & Módulo IA Diagnóstico \\
\hline
TR-62 (RNF-20) & — & CU-06 & HU-29 & CA-29 & Módulo IA Diagnóstico \\
\hline
TR-63 (RNF-21) & EV-01,EV-02 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico \\
\hline
TR-64 (N/A (evento de flujo)) & — & CU-01 & — & — & Módulo Autenticación/Usuarios \\
\hline
TR-65 (N/A (evento de flujo)) & — & CU-01 & — & — & Módulo Autenticación/Usuarios \\
\hline
TR-66 (N/A (evento de flujo)) & — & CU-01 & — & — & Módulo Autenticación/Usuarios \\
\hline
TR-67 (RF-04) & — & CU-02 & — & — & Backend Historiales Clínicos \\
\hline
TR-68 (RF-04) & — & CU-02 & — & — & Backend Historiales Clínicos \\
\hline
TR-69 (RF-04) & — & CU-02 & — & — & Backend Historiales Clínicos \\
\hline
TR-70 (RF-04) & — & CU-02 & — & — & Backend Historiales Clínicos \\
\hline
TR-71 (RF-16) & — & CU-03 & — & — & Backend Historiales Clínicos \\
\hline
TR-72 (RF-02) & — & CU-03 & — & — & Backend Historiales Clínicos \\
\hline
TR-73 (RF-05) & — & CU-04 & — & — & Backend Inventario \\
\hline
TR-74 (RF-06) & — & CU-04 & — & — & Backend Inventario \\
\hline
TR-75 (RF-28) & — & CU-05 & HU-30 & CA-30 & Backend Gestión de Personal \\
\hline
TR-76 (RF-28) & — & CU-05 & HU-30 & CA-30 & Backend Gestión de Personal \\
\hline
TR-77 (RF-28) & — & CU-05 & HU-30 & CA-30 & Backend Gestión de Personal \\
\hline
TR-78 (RF-28) & — & CU-05 & HU-30 & CA-30 & Backend Gestión de Personal \\
\hline
TR-79 (RF-17) & — & CU-06 & — & — & Módulo IA Diagnóstico \\
\hline
TR-80 (RF-13) & — & CU-07 & — & — & Backend Seguimiento Nutricional \\
\hline
TR-81 (RF-14) & — & CU-07 & — & — & Backend Seguimiento Nutricional \\
\hline
TR-82 (RF-09) & — & CU-08 & — & — & Módulo Comunicaciones \\
\hline
TR-83 (RF-10) & — & CU-08 & — & — & Módulo Comunicaciones \\
\hline
TR-84 (RF-06) & — & CU-09 & — & — & Backend Inventario \\
\hline
TR-85 (RF-05) & — & CU-09 & — & — & Backend Inventario \\
\hline
TR-86 (RF-08) & — & CU-10 & — & — & Backend Facturación \\
\hline
TR-87 (RF-08) & — & CU-10 & — & — & Backend Facturación \\
\hline
\end{longtable}
}
...
Trazabilidad Extendida --- Tabla B: trazabilidad de diseño (corregida a partir de matriz\_trazabilidad.csv). Los guiones
(---) indican que el ítem no aplica.}}
\end{quote}
...
\hline
\endlastfoot
TR-01 (RF-01) & Transversal \\
\hline
TR-02 (RF-02) & MU-005\_Ficha\_Paciente \\
\hline
TR-03 (RF-02) & MU-005\_Ficha\_Paciente \\
\hline
TR-04 (RF-03) & MU-003\_Buscar\_Paciente \\
\hline
TR-05 (RF-04) & MU-006\_Registrar\_Consulta \\
\hline
TR-06 (RF-05) & MU-015\_Alerta\_De\_Inventario \\
\hline
TR-07 (RF-06) & MU-024\_Gestion\_Stock \\
\hline
TR-08 (RF-06) & MU-024\_Gestion\_Stock \\
\hline
TR-09 (RF-07) & MU-026\_Registro\_De\_Cobro \\
\hline
TR-10 (RF-08) & MU-027\_Facturacion\_Datos\_Del\_Receptor,MU-028\_Facturacion\_Servicios\_Montos,MU-029\_Confirmar\_Emitir,MU-030\_Facturacion\_Emitida \\
\hline
TR-11 (RF-09) & MU-016\_Comunicaciones \\
\hline
TR-12 (RF-10) & MU-018\_Envio\_Por\_WhatsApp \\
\hline
TR-13 (RF-11) & MU-013\_Registrar\_Citas \\
\hline
TR-14 (RF-11) & MU-013\_Registrar\_Citas \\
\hline
TR-15 (RF-12) & MU-031\_Recordatorios\_De\_Citas \\
\hline
TR-16 (RF-13) & MU-011\_Seguimiento\_De\_Peso \\
\hline
TR-17 (RF-14) & MU-019\_Recomendaciones\_Nutricionales \\
\hline
TR-18 (RF-15) & MU-020\_Recordatorios\_Medicos \\
\hline
TR-19 (RF-16) & MU-021\_Exportar\_Reportes \\
\hline
TR-20 (RF-17) & MU-010\_Sugerencia\_IA \\
\hline
TR-21 (RF-17) & MU-010\_Sugerencia\_IA \\
\hline
TR-22 (RF-18) & MU-010\_Sugerencia\_IA \\
\hline
TR-23 (RF-18) & MU-010\_Sugerencia\_IA \\
\hline
TR-24 (RF-19) & MU-010\_Sugerencia\_IA \\
\hline
TR-25 (RF-20) & Transversal \\
\hline
TR-26 (RF-21) & Transversal \\
\hline
TR-27 (RF-22) & MU-001\_Login \\
\hline
TR-28 (RF-23) & MU-032\_Log\_De\_Auditoria \\
\hline
TR-29 (RF-24) & MU-001\_Login \\
\hline
TR-30 (RF-25) & MU-033\_Reportes\_Gerenciales \\
\hline
TR-31 (RF-26) & Falta crear (no existe en el catálogo de 33 MU) \\
\hline
TR-32 (RF-27) & Falta crear (no existe en el catálogo de 33 MU) \\
\hline
TR-33 (RNF-01) & MU-003\_Buscar\_Paciente \\
\hline
TR-34 (RNF-02) & MU-027\_Facturacion\_Datos\_Del\_Receptor,MU-028\_Facturacion\_Servicios\_Montos,MU-029\_Confirmar\_Emitir,MU-030\_Facturacion\_Emitida \\
\hline
TR-35 (RNF-03) & MU-015\_Alerta\_De\_Inventario \\
\hline
TR-36 (RNF-04) & Transversal \\
\hline
TR-37 (RNF-05) & MU-001\_Login \\
\hline
TR-38 (RNF-06) & MU-032\_Log\_De\_Auditoria \\
\hline
TR-39 (RNF-07) & Transversal \\
\hline
TR-40 (RNF-08) & Transversal \\
\hline
TR-41 (RNF-09) & MU-010\_Sugerencia\_IA \\
\hline
TR-42 (RNF-10) & No aplica \\
\hline
TR-43 (RNF-11) & No aplica \\
\hline
TR-44 (RNF-12) & No aplica \\
\hline
TR-45 (RNF-13) & No aplica \\
\hline
TR-46 (RNF-14) & No aplica \\
\hline
TR-47 (RNF-15) & Transversal \\
\hline
TR-48 (RNF-16) & No aplica \\
\hline
TR-49 (RNF-17) & No aplica \\
\hline
TR-50 (RNF-18) & MU-010\_Sugerencia\_IA \\
\hline
TR-51 (RST-01) & No aplica \\
\hline
TR-52 (RST-02) & Transversal \\
\hline
TR-53 (RST-03) & No aplica \\
\hline
TR-54 (RST-04) & No aplica \\
\hline
TR-55 (RST-05) & MU-010\_Sugerencia\_IA \\
\hline
TR-56 (RST-06) & MU-001\_Login \\
\hline
TR-57 (RST-07) & MU-032\_Log\_De\_Auditoria \\
\hline
TR-58 (RST-08) & MU-010\_Sugerencia\_IA \\
\hline
TR-59 (RST-09) & No aplica \\
\hline
TR-60 (RST-10) & No aplica \\
\hline
TR-61 (RNF-19) & MU-010\_Sugerencia\_IA \\
\hline
TR-62 (RNF-20) & MU-010\_Sugerencia\_IA \\
\hline
TR-63 (RNF-21) & MU-010\_Sugerencia\_IA \\
\hline
TR-64 (N/A (evento de flujo)) & — \\
\hline
TR-65 (N/A (evento de flujo)) & — \\
\hline
TR-66 (N/A (evento de flujo)) & — \\
\hline
TR-67 (RF-04) & — \\
\hline
TR-68 (RF-04) & — \\
...
Trazabilidad Extendida --- Tabla C: mockup asociado (corregida a partir de matriz\_trazabilidad.csv).}}
\end{quote}
...
estimados por el equipo y se registran en
\texttt{04\_Trazabilidad/priorizacion\_moscow\_kano\_valor.csv},
junto con el WSJF calculado como
$\mathrm{WSJF} = (\text{Valor} + \text{Criticidad temporal} + \text{Reducción de riesgo}) / \text{Tamaño}$.
La estimación de RF-01 a RF-19 fue confirmada por el equipo; la de RF-20 a
RF-27 queda registrada como \emph{Propuesta} en dicho archivo, pendiente de
validación final antes del cierre de la entrega, conforme a la advertencia
global de la guía de la Entrega 4 (2B).
\end{quote}
...
\hline
\endlastfoot
RF-01 & Must & Desempeño & 3 & 4.0 & Bloquea el acceso multiplataforma; base de todo lo demás (Tabla 15). \\
\hline
RF-02 & Must & Básico & 3 & 4.0 & Centraliza la información clínica; dependencia de casi todos los demás RF. \\
\hline
RF-03 & Must & Desempeño & 3 & 6.0 & Resuelve el problema de organización reportado por el personal administrativo; bajo esfuerzo. \\
\hline
RF-04 & Must & Básico & 3 & 4.0 & Registro clínico obligatorio por LOPDP Art. 4 y base del historial. \\
\hline
RF-05 & Must & Desempeño & 3 & 7.0 & Evita pérdidas por vencimiento de inventario, dolor mencionado directamente en entrevistas. \\
\hline
RF-06 & Must & Desempeño & 2 & 6.0 & Gestión de stock complementaria a RF-05, mismo módulo. \\
\hline
RF-07 & Must & Básico & 3 & 4.5 & Registro del cobro; cuello de botella operativo ("la parte más demorada"). \\
\hline
RF-08 & Must & Atractivo & 3 & 4.5 & Reduce el tiempo de facturación, mismo dolor que RF-07. \\
\hline
RF-09 & Should & Básico & 2 & 4.0 & Trazabilidad de comunicación post-consulta con el propietario. \\
\hline
RF-10 & Should & Atractivo & 2 & 4.0 & Canal ya usado por la clínica (WhatsApp), complementario a RF-09. \\
\hline
RF-11 & Must & Básico & 3 & 3.5 & Seguimiento de citas e inasistencias, vacío detectado en el proceso actual. \\
\hline
RF-12 & Should & Atractivo & 2 & 4.0 & Mejora incremental sobre RF-11. \\
\hline
RF-13 & Must & Desempeño & 3 & 3.5 & Seguimiento clínico de peso/condición corporal, valor clínico directo. \\
\hline
RF-14 & Should & Atractivo & 2 & 4.0 & Depende de RF-13, bajo esfuerzo adicional. \\
\hline
RF-15 & Should & Atractivo & 2 & 4.0 & Recordatorio de seguimiento, complementario. \\
\hline
RF-16 & Should & Desempeño & 2 & 5.0 & Exportación de reportes, requerido por LOPDP Art. 17 (portabilidad). \\
\hline
RF-17 & Must & Atractivo & 3 & 3.0 & Núcleo diferencial del sistema (IA); alto riesgo ético/legal. \\
\hline
RF-18 & Must & Básico & 3 & 4.0 & Respaldo bibliográfico de IA, mitiga riesgo de confianza. \\
\hline
RF-19 & Must & Básico & 3 & 4.5 & Control humano obligatorio sobre la IA (RST-05, Art. 20 LOPDP). \\
\hline
RF-20 & Must & Básico & 3 & 6.0 & Usabilidad general, requisito transversal de bajo esfuerzo técnico. \\
\hline
RF-21 & Should & Desempeño & 2 & 2.0 & Operación offline, baja frecuencia según entrevistas (cortes 2-3/5). \\
\hline
RF-22 & Must & Básico & 3 & 4.5 & Control de acceso por perfil; base de seguridad de la que dependen otros RNF. \\
\hline
RF-23 & Should & Básico & 3 & 6.0 & Auditoría de cambios, requerido por LOPDP. \\
\hline
RF-24 & Must & Básico & 3 & 4.5 & Consentimiento informado; autenticación bloqueante para todo el sistema. \\
\hline
RF-25 & Could & Atractivo & 2 & 2.0 & Panel gerencial, valor complementario, no bloqueante. \\
\hline
RF-26 & Must & Básico & 3 & 4.5 & Derechos ARCO; obligación legal directa (LOPDP Art. 7, 8). \\
\hline
RF-27 & Must & Básico & 3 & 4.5 & Portal de derechos ARCO; obligación legal directa (LOPDP Art. 12-15), plazo de 15 días. \\
\hline
RF-28 & Must & Básico & 3 & 4.0 & Gestión de empleados y permisos; soporta CU-05, sin el cual el personal administrativo no puede administrar cuentas del equipo. \\
\hline
\end{longtable}
}
...
combinada MoSCoW + Kano + WSJF (MoSCoW y Kano verificados contra la ficha
oficial de cada RF en la Sección 3.2; Valor de negocio y WSJF calculados y
registrados en \texttt{04\_Trazabilidad/priorizacion\_moscow\_kano\_valor.csv}).
RF-01 a RF-19: estimación confirmada por el equipo. RF-20 a RF-28:
estimación propuesta, pendiente de validación final del equipo antes del
cierre de la entrega. Fuente: elaboración propia (Criterio C6).}}
\end{quote}
...
\begin{quote}
La cobertura demostrada alcanza los 13 RF \emph{Must have} centrales del
sistema. RF-23 y RF-21 quedan marcados según el estado declarado por el
propio equipo en \texttt{05\_MVP/README.md}; no se verificó directamente
contra el código fuente del prototipo (ver estado pendiente en la tabla
anterior). \textbf{(Corrección D4, 20/09/2026: se retira la frase "sin
verificación adicional de mi parte" por estar en primera persona
singular en un documento de autoría colectiva.)}
\end{quote}

\subsubsection{6.1.2 Funcionalidades simuladas}\label{s6-1-2-funcionalidades-simuladas}

\begin{quote}
El MVP implementa un alcance de demostración que permite validar los principales flujos funcionales del sistema. En esta versión, la información utilizada corresponde a datos de demostración y no dispone de persistencia mediante una base de datos conectada. Asimismo, el proceso de autenticación se ejecuta en el frontend y no se integra con un servicio de autenticación backend.

Las funcionalidades de sugerencias diagnósticas asociadas a RF-17, RF-18 y RF-19 utilizan respuestas predefinidas para demostrar el flujo funcional de la propuesta de inteligencia artificial. Estas características forman parte del alcance de demostración del MVP y no representan una implementación de inferencia mediante un modelo de lenguaje en producción.

Las condiciones descritas corresponden al alcance técnico definido para el MVP y se diferencian de los requisitos establecidos para la versión productiva del sistema.
\end{quote}
...
\hline
Video de defensa específico (2 escenarios de la matriz de trazabilidad) --- ya depositado en \texttt{11\_Defensa/video\_defensa.mp4}. & Resuelto; verificar que cubra los 2 escenarios de la matriz de trazabilidad antes del cierre. \\
\hline
\end{longtable}
}
...
\textbf{Video demostrativo general:} pendiente de depósito; no existe
actualmente ningún archivo de video del MVP en el repositorio. La
demostración funcional debe realizarse en vivo mediante el despliegue
descrito arriba.

\textbf{Videos por módulo:} pendientes; la carpeta
\texttt{05\_MVP/Videos\_Demostracion/} no existe en el repositorio
actual. De grabarse, deberán depositarse ahí, uno por pantalla
principal (Dashboard, Pacientes, Historial Clínico, Agenda de Citas,
Inventario, Facturación, IA Diagnóstica, Reportes, Configuración).
\end{quote}
...
catálogo de \textbf{28 requisitos funcionales} (RF-01 a RF-28),
\textbf{21 requisitos no funcionales} cuantificados sobre ISO/IEC
25010:2023 (RNF-01 a RNF-21) y \textbf{10 restricciones de diseño}
(RST-01 a RST-10). La matriz de trazabilidad extendida alcanzó
\textbf{87 filas} (TR-01 a TR-87), enlazando Ley/Objetivo/Interesado/EV
...
se amplió a 41 fuentes primarias verificadas.
\end{quote}
...
\begin{itemize}
  ...
  proyecto. Se adoptó como única fuente de verdad la combinación de
  \texttt{SGCVIA\_RF\_RNF\_Cuantificables.docx} (base técnica) y
  \texttt{C4\_Requisitos\_Legales\_SGCV-IA.docx} (brechas legales),
  fijando el significado definitivo: RF-24 (consentimiento informado
  con registro de fecha y hora), RF-25 (panel de reportes gerenciales),
  RF-26 (solicitud de derechos ARCO) y RF-27 (portal de seguimiento del
...
\begin{itemize}
  ...
  (\texttt{02\_Evidencias/Codificacion\_Tematica/}): ninguno de los
  cuatro se elicitó a partir de una entrevista de campo. RF-24, RF-26
  y RF-27 quedan respaldados por \texttt{EV-04} (Consentimiento
  Informado firmado) como evidencia documental, no de elicitación
  oral; RF-25 (panel de reportes gerenciales) no cuenta con ninguna
  evidencia asociada y se registra como \texttt{EV: ---} en la matriz
  de trazabilidad. Los cuatro son de origen documental (Entrega 1B y
  análisis de cumplimiento legal, Criterio C4).
  \item CU-05 (Administrar Empleados) fue respaldado por RF-28
  (Gestión de empleados y permisos del personal), incorporado en esta
  entrega tras detectarse que el caso de uso, ya modelado desde la
  Sección 4.1, carecía de requisito funcional propio. RF-28 es también
  de origen documental (necesidad operativa identificada por el equipo
  de desarrollo), sin evidencia de entrevista asociada. RF-25 (panel de
...
\begin{quote}
La validez del estudio empírico se discute según las cuatro categorías
habituales en ingeniería de software empírica: interna, externa, de
constructo y de conclusión estadística~\cite{wohlin2012}. Esta
discusión corresponde a la versión completa reportada en el manuscrito
(\texttt{09\_Publicacion/manuscrito\_final.tex}, Sección 6).
\begin{itemize}
  ...
  la muestra. Un segundo riesgo es la posible confusión entre
  explicabilidad y otros constructos relacionados (transparencia,
  confianza, usabilidad o exactitud diagnóstica); se mitiga centrando
  el análisis en la información que debe acompañar a una sugerencia de
  IA y en su especificación como requisito verificable (RNF-18,
  CU-06), sin tratar la confianza del usuario o el desempeño del
  modelo como medidas equivalentes de explicabilidad. \textbf{Alcance
  real declarado:} el guion de entrevista
  (\texttt{Guion\_Entrevista\_v2.0.pdf}) no incluye preguntas
  dedicadas a explicabilidad (la pregunta C5, sobre condiciones de
  confianza, es adyacente pero no equivalente); los 16 participantes
  (P01–P16) son médicos veterinarios, auxiliares o estudiantes en
  formación, sin propietarios no clínicos ni personal administrativo
  puro; y las dos rondas de validación cuantitativa previstas
  específicamente para explicabilidad (protocolo OSF,
  \texttt{Guion\_Validacion\_v2\_0}) no se ejecutaron (ver
  \texttt{07\_Datos/desviaciones.md}, Desviación 1 y declaración D3).
  Por lo tanto, este documento no afirma requisitos de explicabilidad
  diferenciados por perfil de usuario.
  ...
  auditoría externa independiente. Un segundo riesgo es que las
  entrevistas por sí solas no representen completamente la práctica
  clínica y administrativa real; se mitigó complementando las
  entrevistas semiestructuradas con observación directa y evidencia
  documental del contexto organizacional, aunque dicha observación se
  realizó en la misma organización que las entrevistas, por lo que no
  constituye una réplica independiente en otra clínica veterinaria.
  \item \textbf{Validez externa:} la principal amenaza es el diseño de
  que el estudio se limita al contexto de clínicas veterinarias pequeñas y
  medianas en una misma zona de Ecuador: se recolectó evidencia (entrevistas
  y observación documental) en 6 clínicas distintas (VeterinariaColombia,
  VeterinariaMacay, VeterinariaPetCat, VeterinariaDrMONG,
  VeterinariaMediClikPet, Veterinaria911Animal), lo que reduce el riesgo de
  caso único aislado, pero los stakeholders,
  flujos de trabajo, restricciones y entorno regulatorio pueden diferir
  de los de otras clínicas, países o sistemas clínicos asistidos por
  IA; el estudio no reclama generalización estadística, y la
  transferibilidad a otras organizaciones queda como trabajo futuro. Un
  segundo riesgo es la especificidad de dominio: las necesidades de
  explicabilidad identificadas para el diagnóstico veterinario asistido
  por IA pueden no transferirse directamente a la salud humana u otros
  dominios de alto riesgo; se mitiga fundamentando la contribución en
  conceptos de Ingeniería de Requisitos y en la identificación explícita
  del caso de uso al que se traza RNF-18 (CU-06).

  \item \textbf{Validez de conclusión estadística:} la naturaleza
  cualitativa y contextual de la evidencia disponible limita las
  conclusiones a la identificación, especificación y trazabilidad de
  los requisitos de explicabilidad, sin establecer efectos a nivel
  poblacional ni diferencias estadísticamente significativas entre
  grupos de usuarios; por ello no se reporta inferencia estadística en
  esta versión del documento. Un segundo riesgo es la incompletitud de
  la validación empírica terminal al momento de esta entrega: las
  pruebas estadísticas, tamaños de efecto e intervalos de confianza que
  dependen del conjunto de datos experimental se excluyen
  intencionalmente hasta que los scripts de análisis correspondientes
  (Sección 7, criterio C5) se completen y verifiquen, lo que evita
  conclusiones cuantitativas no respaldadas.
\end{itemize}
\end{quote}
...
\begin{longtable}{|
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.16}}|
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.45}}|}
...
CU-06 &
RF-17, RF-18, RF-19, RNF-09, RNF-10, RNF-18, RNF-19, RNF-20, RNF-21,
RST-04, RST-05, RST-08, RL-09, RL-10, RL-11 \\
\hline

\end{longtable}

\subsection{9.2 Clasificación del nivel de riesgo del componente}
\label{s9-2-clasificacion-riesgo}

\begin{quote}
Siguiendo un enfoque de clasificación de riesgo por niveles (análogo al
adoptado por el Reglamento de IA de la Unión Europea y por guías
sectoriales de IA en salud), \textbf{IA-01} se clasifica como componente
de \textbf{riesgo alto}, no de riesgo mínimo o limitado. La clasificación
se justifica por lo siguiente:

\begin{itemize}
  \item El componente procesa datos clínicos de pacientes (categoría
  especial de datos personales, LOPDP Art. 25-31) para generar una
  sugerencia que incide directamente sobre una decisión de salud animal.
  \item Una sugerencia incorrecta no revisada podría inducir a un
  diagnóstico o tratamiento erróneo, con daño potencial al paciente.
  \item El componente interactúa con un proveedor externo de IA/LLM
  (RST-04), lo que introduce una dependencia de un tercero cuyo
  comportamiento no está enteramente bajo control del equipo de
  desarrollo.
\end{itemize}

Esta clasificación de riesgo alto es la que fundamenta que RST-05,
RST-08, RNF-19, RNF-20 y RNF-21 sean de prioridad \emph{Must have}: la
supervisión humana obligatoria, la equidad entre subgrupos y el
monitoreo posterior al despliegue no son mejoras opcionales sino
condiciones necesarias para que un componente de este nivel de riesgo
sea aceptable en producción.
\end{quote}

\section{APÉNDICE}
\label{apendice-general}
...
\end{minipage} \\
\hline
Entrevista semiestructurada --- P01 (Entrevistado 1) &
24/05/2026 & 24/05/2026 & \begin{minipage}[t]{\linewidth}\raggedright
Marcillo / Vera
\end{minipage} \\
\hline
Entrevista semiestructurada --- P02 (Entrevistado 2) & 25/05/2026 &
...
-- Médico veterinario y propietario de la Organización A &
\begin{minipage}[t]{\linewidth}\raggedright
...
Médico veterinario de la Organización B &
\begin{minipage}[t]{\linewidth}\raggedright
...
\end{minipage} & Sí \\
\hline
\textbf{EV-03} & Observación de campo & 23/05/2026 & Organización
A & \begin{minipage}[t]{\linewidth}\raggedright
Observación de los procesos de atención y registro de información clínica.
\end{minipage} & N/A \\
\hline
\textbf{EV-05} & Entrevista (audio y video) & 21/07/2026 & P03 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-21\_Transcripcion\_P03\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-06} & Entrevista (audio y video) & 25/07/2026 & P04 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-25\_Transcripcion\_P04\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-07} & Entrevista (audio y video) & 25/07/2026 & P05 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-25\_Transcripcion\_P05\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-08} & Entrevista (audio y video) & 27/07/2026 & P06 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-27\_Transcripcion\_P06\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-09} & Entrevista (audio y video) & 27/07/2026 & P07 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-27\_Transcripcion\_P07\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-10} & Entrevista (audio y video) & 28/07/2026 & P08 & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-07-28\_Transcripcion\_P08\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-11} & Entrevista (audio y video) & 31/08/2026 & P09 -- Médico veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P09\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-12} & Entrevista (audio y video) & 31/08/2026 & P10 -- Médico veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P10\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-13} & Entrevista (audio y video) & 31/08/2026 & P11 -- Médico veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P11\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-14} & Entrevista (audio y video) & 31/08/2026 & P12 -- Auxiliar de veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P12\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-15} & Entrevista (audio y video) & 31/08/2026 & P13 -- Auxiliar de veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P13\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-16} & Entrevista (audio y video) & 31/08/2026 & P14 -- Auxiliar de veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P14\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-17} & Entrevista (audio y video) & 31/08/2026 & P15 -- Médico veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P15\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\textbf{EV-18} & Entrevista (audio y video) & 31/08/2026 & P16 -- Médico veterinario & \begin{minipage}[t]{\linewidth}\raggedright
Ver transcripción: \texttt{02\_Evidencias/Transcripciones/2026-08-31\_Transcripcion\_P16\_Entrevista.md}
\end{minipage} & Sí \\
\hline
\end{longtable}
}
...
\setcounter{enumi}{1}
\item
  \textbf{--- Acta de Entrevista N.° 2: Organización B}
\end{enumerate}
...
% ============================================================
% ACTAS DE ENTREVISTA P03\textendash{}P16 (generadas a partir de
% Transcripciones_P01-P16.zip). Se insertan a continuación de la
% Tabla 23 (Acta de Entrevista N.\textdegree{} 2 - hallazgos, P02)
% y antes de "Análisis Comparativo de las Entrevistas", que en su
% forma original sigue comparando únicamente a P01 y P02.
%
% Numeración: se usa el esquema "Tabla 23.N" para no forzar una
% renumeración de las Tablas 24 en adelante, que ya existen en el
% resto del documento y podrían estar referenciadas en otras
% secciones (p. ej. la Tabla 25 de Clasificación de Requisitos).
% ============================================================

\begin{quote}
A continuación se documentan, con el mismo formato aplicado a P01 y P02,
las actas de entrevista y los hallazgos clave de los 14 participantes
adicionales (P03 a P16), a partir de las transcripciones disponibles en
\texttt{02\_Evidencias/Transcripciones/}. Para P09 a P16 las transcripciones
fueron generadas automáticamente a partir de audio (ver nota de
anonimización en cada archivo fuente); el rol indicado en la Tabla 19 se
mantuvo salvo en el caso de P15, donde la propia transcripción contradice
esa etiqueta (ver nota en su acta).
\end{quote}

\subparagraph{Acta de Entrevista --- P03}\label{acta-entrevista-p03}
...
\hline
\endlastfoot
\textbf{Stakeholder entrevistado} & \begin{minipage}[t]{\linewidth}\raggedright
P03
\end{minipage} \\
\hline
\textbf{Rol declarado} & \begin{minipage}[t]{\linewidth}\raggedright
Médico veterinario
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA (nombre no registrado en la transcripción).
\end{minipage} \\
\hline
\textbf{Fecha de la entrevista} & \begin{minipage}[t]{\linewidth}\raggedright
21 de julio de 2026
\end{minipage} \\
\hline
\textbf{Lugar} & \begin{minipage}[t]{\linewidth}\raggedright
Clínica del participante (veterinaria de reciente apertura)
\end{minipage} \\
\hline
\textbf{Modalidad} & \begin{minipage}[t]{\linewidth}\raggedright
Remota/telefónica, con grabación de audio y consentimiento informado.
\end{minipage} \\
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
aprox. 14 minutos.
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
\end{minipage} \\
\hline
\textbf{Objetivo de la sesión} & \begin{minipage}[t]{\linewidth}\raggedright
Recopilar información sobre los procesos clínicos, administrativos y las necesidades de la clínica veterinaria para identificar los requisitos del Sistema de Gestión Clínica Veterinaria con Inteligencia Artificial (SGCV-IA).
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P03_acta}{}\emph{\textbf{Tabla 23.1. Acta de Entrevista --- P03}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Registra la información clínica mediante documentos de Word (historia clínica y datos del propietario); no usa software especializado.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Guardar muchos documentos separados obliga a una búsqueda manual que toma tiempo.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
La mayor dificultad es la recolección de los datos del propietario; se emite factura electrónica.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
No lleva inventario formal: la clínica opera con solo dos personas y confían en el control informal entre ellas.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Las inasistencias son muy raras; en hospitalización el pago se cobra por adelantado, con impacto positivo.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación honesta y clara con el propietario para mantener una buena imagen del servicio.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Control de peso y talla semanal; para cachorros sigue un cronograma de 6 meses (día 10, día 21, mes y medio) y ajusta la frecuencia según la patología.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Los dueños casi no preguntan; el veterinario orienta proactivamente sobre alimentación casera vs. balanceada y advierte sobre alimentos tóxicos (ajo, cebolla).
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Realiza chequeos diarios post-alta por mensajes, llamadas o videollamadas para asegurar el cumplimiento del tratamiento.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisa si se cumplió la medicación indicada y realiza un nuevo análisis para ajustar el tratamiento.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Uso digital muy bajo; sin software de IA; participa en un grupo de mensajería solo entre veterinarios.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
5/5 — totalmente de acuerdo con que un sistema inteligente analice datos clínicos para sugerir diagnósticos.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
El chequeo de pacientes hospitalizados genera la mayor carga y desgaste; considera que la IA no puede reemplazar la evaluación física directa.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
No declara un nivel de confianza explícito en la escala, pero condiciona el uso a la revisión veterinaria.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que el veterinario pueda revisar y aplicar las recomendaciones a su propio criterio antes de usarlas.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Un programa que permita llevar el historial clínico completo del paciente.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
No percibe urgencia por ser una clínica nueva; la adopción sería gradual.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Cualquier dispositivo indistintamente (celular o laptop).
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
Nunca (1/5) — no reporta problemas de conectividad.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
No identifica necesidades adicionales no abordadas en la entrevista.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P03_hallazgos}{}\emph{\textbf{Tabla 23.2. Acta de Entrevista P03 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P04}\label{acta-entrevista-p04}
...
\protect\phantomsection\label{_bookmark_P04_acta}{}\emph{\textbf{Tabla 23.3. Acta de Entrevista --- P04}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Historial clínico gestionado en una aplicación tipo Microsoft (agenda/notas digitales).
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
La búsqueda por nombre no está bien organizada, lo que dificulta localizar un registro rápido.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
La facturación en línea es lenta (abrir el programa, ingresar cliente y producto); es la etapa más demorada del proceso.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Ha tenido problemas con productos vencidos: el programa de facturación no permite registrar fecha de vencimiento, solo código y precio; la verificación es manual.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Frecuencia moderada de inasistencias; el impacto principal es clínico (se desconoce la evolución del paciente), no económico.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
El seguimiento y la próxima cita se incluyen en la receta impresa; los resultados de exámenes se envían por WhatsApp.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registra en el mismo sistema, aunque a veces es difícil encontrar un registro específico.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Los dueños casi no preguntan sobre alimentación; cuando lo hacen, se elabora una receta explicada.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
El cumplimiento se verifica en las citas de seguimiento posteriores.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Vuelve a citar al paciente para revisión.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Reconoce que un sistema de IA debería considerar estado, edad y raza del paciente antes de sugerir un diagnóstico.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
No se registra un valor numérico explícito en la transcripción.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisar y corregir las sugerencias del sistema antes de aplicarlas sería la tarea de mayor carga asociada a la IA.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza condicionada a poder revisar y corregir las sugerencias.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que pueda revisar y corregir todas las sugerencias antes de aplicarlas.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Resolver primero el tema de alimentación/nutrición, de forma rápida y cómoda.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Facilidad de uso, portabilidad (móvil y computadora), sencillez y utilidad práctica.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora o teléfono móvil, con preferencia por el móvil.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
Rara vez (no nunca) hay problemas de conectividad.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Considera que todo quedó cubierto en una visita anterior del equipo.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P04_hallazgos}{}\emph{\textbf{Tabla 23.4. Acta de Entrevista P04 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P05}\label{acta-entrevista-p05}
...
\hline
\textbf{Rol declarado} & \begin{minipage}[t]{\linewidth}\raggedright
Médico veterinario (negocio de venta de productos veterinarios)
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA (nombre no registrado en la transcripción).
...
\protect\phantomsection\label{_bookmark_P05_acta}{}\emph{\textbf{Tabla 23.5. Acta de Entrevista --- P05}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Los propietarios suelen acercarse en la etapa terminal de la enfermedad del animal.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Falta de información de los propietarios sobre síntomas y antecedentes previos.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Sin inconvenientes relevantes: se informa el costo antes del tratamiento y se cobra en efectivo, en un entorno de confianza.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Los productos caducan por falta de control sistemático; no existe un inventario formal.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
No aplica: el negocio opera como punto de venta de productos, sin sistema de citas.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación por vía telefónica y coordinación de próximas citas.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
El seguimiento nutricional se orienta según la edad y etapa de crecimiento; inculca alimentación adecuada por raza.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Recomendaciones basadas en la condición corporal observada en consulta presencial.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Se espera un cumplimiento riguroso (dosis y horarios exactos); los controles programados son esenciales.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Si no mejora por incumplimiento, indica pruebas de sangre o refiere a una clínica con mayor equipamiento.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
No utiliza ningún tipo de software.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada; considera que el diagnóstico depende de la práctica y de ver al paciente directamente.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que sea confiable científicamente para diagnosticar animales.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Una base de datos que ayude a llevar la contabilidad del negocio.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Ninguna adicional; reconoce la necesidad de adaptarse a la modernización tecnológica.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P05_hallazgos}{}\emph{\textbf{Tabla 23.6. Acta de Entrevista P05 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P06}\label{acta-entrevista-p06}
...
\hline
\textbf{Lugar} & \begin{minipage}[t]{\linewidth}\raggedright
Clínica del participante (Quevedo)
\end{minipage} \\
\hline
\textbf{Modalidad} & \begin{minipage}[t]{\linewidth}\raggedright
Remota/telefónica, con grabación de audio y consentimiento informado.
...
\protect\phantomsection\label{_bookmark_P06_acta}{}\emph{\textbf{Tabla 23.7. Acta de Entrevista --- P06}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Cuando los animales llegan por abandono, faltan datos básicos como edad, alimentación previa o motivo de ingreso.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Dato fusionado con A1 en la entrevista: la falta de información de origen dificulta el historial inicial.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Los cobros se registran mediante el facturador del SRI.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Pocos problemas por vencimiento (los proveedores avisan la fecha de caducidad); ocasionales faltantes por dificultades logísticas de la zona.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Rara vez rechazan una cita salvo en cirugías; se gestiona según la hora de llegada.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Indicaciones de vuelta y seguimiento por WhatsApp.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Control de peso registrado en la ficha médica del paciente.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultan poco sobre alimentación, mayormente cuando ya hay un problema digestivo por comida casera; orientan sobre alimentos dañinos (condimentos, cebolla) y sanos (lechuga, zanahoria, avena).
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Muy bajo cumplimiento; se prefiere la hospitalización para mantener observación directa.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Verifica si se siguió la medicación indicada; si no mejora, deriva a otra clínica para exámenes.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
No utiliza ninguna herramienta digital.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Recordar tareas médicas (agenda) genera carga de trabajo.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada, como apoyo.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que el veterinario pueda revisar y corregir las sugerencias, y que existan actualizaciones periódicas.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Registro de paciente y control de vacunas con recordatorios automáticos.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
El precio es el factor decisivo para la adopción (ya probaron una herramienta gratuita anteriormente).
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
No se registró una respuesta explícita en la transcripción.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
...
\protect\phantomsection\label{_bookmark_P06_hallazgos}{}\emph{\textbf{Tabla 23.8. Acta de Entrevista P06 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P07}\label{acta-entrevista-p07}
...
\protect\phantomsection\label{_bookmark_P07_acta}{}\emph{\textbf{Tabla 23.9. Acta de Entrevista --- P07}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Fichas clínicas físicas impresas; no se respaldan en la nube.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Los tutores llegan acelerados por la urgencia y no responden bien las preguntas, dificultando obtener antecedentes.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Cobros gestionados sin complicación mediante el SRI.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Pocos problemas con productos vencidos, ya que el SRI permite revisar la fecha periódicamente; no usa Excel.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Muy pocas inasistencias, ya que no se agenda cita previa (los pacientes solo llegan).
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
...
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registro del peso en la ficha física y en el carnet de vacunación.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultan poco, generalmente cuando el animal ya presenta un problema (por ejemplo, tras comer cebolla).
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Cumplimiento poco frecuente; a veces no dejan al paciente hospitalizado por razones económicas.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Recomienda traer al paciente; de no ser posible, solicita una foto pero prioriza la revisión presencial.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
El seguimiento de pacientes que vuelven a casa genera carga de trabajo.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada, con validación propia.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que el veterinario pueda revisar y corregir las sugerencias antes de aplicarlas.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Recordatorios automáticos de vacunas para los dueños (sistema de notificaciones).
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Que sea una herramienta segura y con pocos errores o caídas.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Laptop y celular, con mayor uso del celular por su portabilidad.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
No se capturó una respuesta explícita en la transcripción.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Ninguna necesidad adicional identificada.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P07_hallazgos}{}\emph{\textbf{Tabla 23.10. Acta de Entrevista P07 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P08}\label{acta-entrevista-p08}
...
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA .
\end{minipage} \\
\hline
\textbf{Fecha de la entrevista} & \begin{minipage}[t]{\linewidth}\raggedright
28 de julio de 2026
...
\protect\phantomsection\label{_bookmark_P08_acta}{}\emph{\textbf{Tabla 23.11. Acta de Entrevista --- P08}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa un software ("HED") para citas, historia clínica, tratamientos y diagnósticos, con registro completo de propietario y mascota.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
No reporta dificultades relevantes: el software permite ubicar rápidamente al paciente por nombre del propietario.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa un facturador básico y sencillo, sin problemas relevantes.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Sí ha tenido problemas por productos vencidos (medicamentos); el software apoya el inventario, pero a veces no se revisa a tiempo.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Inasistencias poco frecuentes (5-10%); no hay una sala de espera formal, se atiende directamente.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
El software envía una alarma para las próximas citas.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Controles de cachorro cada 21 días, con peso y valoración adicional en cada cita.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas sobre alimentación muy frecuentes (~99%); orienta activamente y advierte sobre comidas condimentadas o dañinas (como la cebolla).
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Buen cumplimiento reportado; depende en gran medida de la responsabilidad del propietario.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Solicita comprobantes (blísteres, bolsas de alimento) para verificar si realmente se siguió la dieta indicada.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
El software (HED) es considerado bastante completo, aunque su uso recae en el veterinario en lugar de en personal administrativo.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
La atención por mensajería/chat genera la mayor carga; sugiere automatizar respuestas para agendar citas.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Respaldo en literatura científica validada, revisión veterinaria previa, facilidad de uso y protección de datos.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Automatizar el envío de recordatorios de citas sin intervención manual.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
No se especifica de forma explícita en la transcripción.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Considera que todo fue abordado en la entrevista.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P08_hallazgos}{}\emph{\textbf{Tabla 23.12. Acta de Entrevista P08 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P09}\label{acta-entrevista-p09}
...
\hline
\textbf{Rol declarado} & \begin{minipage}[t]{\linewidth}\raggedright
Veterinario/a (por confirmar; transcripción generada automáticamente)
\end{minipage} \\
\hline
\textbf{Nota sobre el rol} & \begin{minipage}[t]{\linewidth}\raggedright
Rol pendiente de confirmación explícita por el equipo (transcripción automática sin nombres propios).
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA.
...
\hline
\textbf{Lugar} & \begin{minipage}[t]{\linewidth}\raggedright
Clínica de reciente apertura del participante
\end{minipage} \\
\hline
\textbf{Modalidad} & \begin{minipage}[t]{\linewidth}\raggedright
Remota (audio y video), transcripción automática; consentimiento informado verbal registrado en el audio.
\end{minipage} \\
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 16 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P09_acta}{}\emph{\textbf{Tabla 23.13. Acta de Entrevista --- P09}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Anota la información en una libreta física y en el teléfono mediante Word; no usa ningún software.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Buscar historias retrocediendo entre anotaciones en papel demora, sobre todo si pasó tiempo desde la última visita.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Todo el proceso es físico (calculadora y cuaderno de ventas), sin contabilidad digital.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisa los medicamentos al llegar la factura del proveedor para verificar vencimientos; no lleva inventario formal, está evaluando aplicaciones de inventario.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Las cancelaciones de último momento (p. ej. citas de peluquería) generan huecos en la agenda; usan WhatsApp para recordar, pero igual se olvidan.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación permanente por WhatsApp, reenviando resultados de exámenes.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Seguimiento con carnet físico (sin versión digital); conoce por referencia sistemas con control de peso digital.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Los dueños consultan en cada visita; no existe un recordatorio proactivo de alimentación.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Hace seguimiento por WhatsApp preguntando si se cumplió la medicación; cita de control a los 8 días.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Solicita una foto de referencia, pero de igual forma exige traer al animal para palparlo físicamente.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
No usa software; solo herramientas básicas (WhatsApp, hojas de cálculo).
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Llevar el historial clínico es la tarea que más carga genera.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada (apoyo, con validación propia).
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que los datos no se compartan con terceros y que exista respaldo/validación científica.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Contar con inventario e historia clínica en formato digital.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Ya tiene experiencia previa con un software en otra clínica, por lo que se adaptaría con facilidad.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora y también teléfono (lo usa a diario).
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
2/5 (baja frecuencia de problemas de conectividad).
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
No identifica necesidades adicionales.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P09_hallazgos}{}\emph{\textbf{Tabla 23.14. Acta de Entrevista P09 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P10}\label{acta-entrevista-p10}
...
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 13 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P10_acta}{}\emph{\textbf{Tabla 23.15. Acta de Entrevista --- P10}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa principalmente registros digitales, con algunos documentos físicos; en jornadas ocupadas no siempre logra completar todos los datos.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Localizar antecedentes y resultados de exámenes anteriores toma tiempo cuando hay muchos pacientes.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Se revisan procedimientos y medicamentos para calcular el valor total; los errores aparecen al comprobar manualmente varios procedimientos.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisiones periódicas con registro de entradas y salidas; es difícil detectar con anticipación medicamentos por vencer o agotarse.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Ocurren cancelaciones mensuales; el espacio se reasigna a otro paciente en la agenda.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
WhatsApp y llamadas para indicaciones, resultados y recordatorios; el seguimiento manual consume bastante tiempo.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registra peso y condición corporal en cada consulta, comparando con registros anteriores.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas sobre alimentación frecuentes, considerando edad, peso, actividad y condición de salud.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
El cumplimiento depende de cada propietario; se verifica en la siguiente consulta.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Dato no capturado de forma independiente (se fusiona con B3 en la transcripción).
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa hojas de cálculo como principal herramienta digital.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
No se registra un valor numérico claro en la transcripción (posible corte de audio).
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Le gustaría apoyo de IA en historias clínicas y evolución del tratamiento, para no tardar tanto en cada consulta.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada, para comparar con su propio criterio.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Protección de datos, soporte técnico con actualizaciones periódicas y facilidad de uso (selecciona varias opciones).
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Acceso rápido al historial completo del paciente e identificación de tratamientos/controles/citas pendientes.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Rápida, sencilla y fácil de aprender; debe funcionar en computadora y en teléfono.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
1/5 — nunca ha tenido problemas de conexión.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Alertas para controles, vacunas y tratamientos; registro de auditoría de quién modificó cada dato.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P10_hallazgos}{}\emph{\textbf{Tabla 23.16. Acta de Entrevista P10 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P11}\label{acta-entrevista-p11}
...
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 14 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P11_acta}{}\emph{\textbf{Tabla 23.17. Acta de Entrevista --- P11}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Combina registros digitales (datos básicos) con documentos físicos (observaciones); la información queda dispersa.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
La información de consultas anteriores no está en un solo lugar, lo que complica las urgencias.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
El valor se calcula tras registrar el servicio realizado; los errores aparecen al repetir datos o acumular varias atenciones.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisión manual de existencias y vencimientos; sería útil contar con alertas de agotamiento o vencimiento.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Ocurren cancelaciones que dejan espacios libres; los recordatorios por mensaje o llamada no siempre logran contactar a tiempo.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
WhatsApp o llamadas; considera que sería conveniente un proceso más organizado para evitar retrasos en la comunicación.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registra el peso comparando con controles anteriores, junto con condición corporal, raza, edad y actividad; sin registros completos es difícil detectar tendencias.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas frecuentes, sobre todo en cachorros, sobrepeso o dietas específicas; las recomendaciones consideran peso, edad, actividad y condición del animal.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
El cumplimiento depende del propietario; se entera por llamada o en la siguiente consulta; los recordatorios automáticos ayudarían.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Pide información de síntomas, alimentación y medicación, y solicita fotos o videos, pero prefiere la consulta presencial ante posible complicación.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa herramientas digitales básicas para registrar información y comunicarse con los propietarios.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
4-5/5, condicionado a que la decisión final sea siempre del veterinario.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
El seguimiento de pacientes y la comunicación con propietarios son las tareas que más tiempo consumen; centralizarlas ayudaría.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada (lo usaría como segunda opción, revisando siempre la información antes de decidir).
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Respaldo en literatura científica validada y que el veterinario pueda revisar/corregir las sugerencias.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Tener un solo lugar con la información de los pacientes y el seguimiento de las citas.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Fácil de aprender, sencilla y rápida; que funcione bien desde el celular y cuente con soporte técnico.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora/laptop en la clínica y móvil cuando necesita revisar información fuera del consultorio.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Historial completo y ordenado, recordatorios de vacunas/controles/tratamientos/citas; la IA como apoyo y no como sustituto del profesional.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P11_hallazgos}{}\emph{\textbf{Tabla 23.18. Acta de Entrevista P11 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P12}\label{acta-entrevista-p12}
...
\protect\phantomsection\label{_bookmark_P12_acta}{}\emph{\textbf{Tabla 23.19. Acta de Entrevista --- P12}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa un sistema básico en computadora, complementado con fichas físicas para ciertas observaciones; se complica con muchos pacientes.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Encontrar antecedentes rápido es difícil, sobre todo si la ficha física fue registrada por otro veterinario.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
El cobro se calcula tras sumar consulta, procedimientos y productos; los errores aparecen al transcribir manualmente o en facturas con varios servicios.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisiones periódicas con hoja de cálculo; productos con pocas unidades o cerca de vencer no siempre se detectan a tiempo.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Inasistencias varias veces al mes; los recordatorios ayudan, pero deberían ser automáticos.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
WhatsApp, llamadas y mensajes; revisan notas previas antes de contactar al propietario.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registra peso comparando con controles previos, junto con condición corporal, edad, raza y actividad; útil contar con gráficas o alertas de evolución.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas sobre alimentación muy comunes, basadas en las características y condición clínica del animal.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Cumplimiento variable; se verifica en controles o llamadas de seguimiento.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Pregunta síntomas, alimentación y medicación, pide fotos o videos, pero exige revisión presencial ante señales de alarma.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa un software veterinario completo con todas las opciones.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisar seguimientos, resultados de citas pendientes y mantener actualizados los historiales consume bastante tiempo.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza alta pero condicionada a que el veterinario pueda revisar y corregir las sugerencias.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Respaldo científico y que el veterinario pueda revisar, modificar o rechazar cualquier sugerencia antes de aplicarla.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Organización centralizada de historiales y control de citas.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Sencilla, rápida, con capacitación breve del personal, permisos por usuario y respaldo de la información.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora/laptop principalmente; ocasionalmente el teléfono.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
2/5 (interrupciones breves ocasionales).
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Alertas de vacunas, controles y tratamientos, además de un historial de comunicaciones por propietario.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P12_hallazgos}{}\emph{\textbf{Tabla 23.20. Acta de Entrevista P12 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P13}\label{acta-entrevista-p13}
...
\hline
\textbf{Rol declarado} & \begin{minipage}[t]{\linewidth}\raggedright
Auxiliar de veterinario (estudiante, en formación)
\end{minipage} \\
\hline
\textbf{Nota sobre el rol} & \begin{minipage}[t]{\linewidth}\raggedright
La propia transcripción confirma el rol de auxiliar/estudiante en formación bajo supervisión de un médico veterinario.
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA (nombre no registrado en la transcripción).
...
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 20 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P13_acta}{}\emph{\textbf{Tabla 23.21. Acta de Entrevista --- P13}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Todo se anota en un único cuaderno cronológico de consultas (no organizado por paciente); cada registro toma unos 8 minutos.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Buscar en el cuaderno página por página es lento y crítico en situaciones de urgencia.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
El cobro lo hace el doctor de forma manual y se anota aparte en un cuaderno de caja; los montos a veces no coinciden entre ambos registros.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Sin control formal de inventario; la revisión es "a ojo" y los vencimientos suelen detectarse tarde, generando pérdidas.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
No hay agenda formal (se atiende por orden de llegada); el problema aparece en controles de vacunas o cirugías donde a veces no regresan.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Resultados enviados por redes sociales o llamadas del doctor; no existe un proceso estandarizado.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
El peso se anota en el cuaderno sin poder graficar o comparar fácilmente; solo se revisa visualmente si el animal está delgado o con sobrepeso.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas diarias sobre alimentación; la recomendación depende de la experiencia del doctor, sin guía estandarizada.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Cumplimiento muy bajo (suspenden la medicación al ver mejoría); casi no hay seguimiento activo desde la clínica.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Se pide traer al paciente para una nueva revisión; en casos leves el doctor ajusta por teléfono.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
No utiliza ningún software; todo es manual (cuaderno).
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
5/5 — totalmente de acuerdo, ve potencial para no pasar por alto detalles importantes.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Buscar información desorganizada de pacientes ya atendidos genera la mayor carga diaria.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Alta confianza (la usaría como referencia directa, dado que aún está en formación).
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Respaldo científico validado y facilidad de uso sin necesidad de capacitación prolongada.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Organizar la información del paciente por fecha y nombre, en vez de un único cuaderno cronológico.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Sencilla de aprender y accesible desde el celular.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora, con preferencia por el teléfono móvil.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
4/5 — los cortes de conectividad ocurren con frecuencia.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Registrar fotos del paciente (heridas, evolución) junto con la ficha clínica.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P13_hallazgos}{}\emph{\textbf{Tabla 23.22. Acta de Entrevista P13 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P14}\label{acta-entrevista-p14}
...
\hline
\textbf{Nota sobre el rol} & \begin{minipage}[t]{\linewidth}\raggedright
La propia transcripción confirma el rol de auxiliar, que apoya al veterinario y consulta con él antes de modificar cualquier indicación.
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA (nombre no registrado en la transcripción).
...
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 11 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P14_acta}{}\emph{\textbf{Tabla 23.23. Acta de Entrevista --- P14}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Registro principalmente en computadora, con algunos datos en formatos físicos; como auxiliar apoya tomando datos y verificando indicaciones.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Los registros de distintas consultas no están organizados de la misma manera; en una urgencia sería ideal ver antecedentes, vacunas, alergias y medicamentos en una sola pantalla.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Se confirman procedimientos, medicamentos y productos antes del cobro; hay demoras cuando una atención incluye varios servicios.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisiones periódicas con anotación de cantidades; no existe una alerta automática de vencimiento o bajo stock.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Ocurre ocasionalmente (el propietario olvida la cita), dejando vacíos en la agenda.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
WhatsApp y llamadas; como auxiliar envía recordatorios e información indicada por el veterinario, siempre consultando al profesional.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
El peso se registra en cada consulta y se compara con visitas anteriores; sería útil un sistema con gráficos de evolución.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas frecuentes (cachorros, sobrepeso, necesidades específicas); orienta en aspectos generales y deriva casos de enfermedad al veterinario.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
Cumplimiento variable (olvidan horarios o suspenden el tratamiento); se detecta en la llamada de seguimiento o en la próxima consulta.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Recoge datos de síntomas, alimentación y cumplimiento y los comunica al veterinario; no modifica indicaciones por cuenta propia.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
No usa software especializado; solo herramientas básicas de mensajería y agenda.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
4/5 — bastante de acuerdo, con la decisión final siempre a cargo del veterinario.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Organizar la agenda y verificar controles pendientes consume tiempo; sería útil automatizar recordatorios y alertas de insumos.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza media-alta, si las recomendaciones muestran su origen y el veterinario puede revisarlas.
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Protección de datos de los pacientes y respaldo en información veterinaria confiable.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Reducir el tiempo de búsqueda de información y organización de la agenda; ver de inmediato citas, tratamientos y tareas pendientes.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Sencilla, rápida y con instrucciones claras; permisos según el cargo y respaldo de la información.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora en la clínica para registrar y revisar; celular para la agenda y las alertas.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
No se capturó una escala numérica explícita en la transcripción.
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Que el sistema guarde los datos temporalmente y los sincronice al recuperar la conexión (operación offline).
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P14_hallazgos}{}\emph{\textbf{Tabla 23.24. Acta de Entrevista P14 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P15}\label{acta-entrevista-p15}
...
\hline
\textbf{Rol declarado} & \begin{minipage}[t]{\linewidth}\raggedright
Auxiliar de veterinario / estudiante de zootecnia
\end{minipage} \\
\hline
\textbf{Nota sobre el rol} & \begin{minipage}[t]{\linewidth}\raggedright
La Tabla 19 (EV-17) etiqueta a P15 como "Médico veterinario", pero la propia transcripción indica que es auxiliar en formación (estudiante de zootecnia) bajo supervisión veterinaria; se corrige aquí a partir de la fuente primaria.
\end{minipage} \\
\hline
\textbf{Entrevistador} & \begin{minipage}[t]{\linewidth}\raggedright
Equipo de investigación SGCV-IA (nombre no registrado en la transcripción).
...
\hline
\textbf{Duración aproximada} & \begin{minipage}[t]{\linewidth}\raggedright
Aprox. 19 minutos (estimado a partir de las marcas de tiempo del audio transcrito).
\end{minipage} \\
\hline
\textbf{Técnica de elicitación} & \begin{minipage}[t]{\linewidth}\raggedright
Entrevista semiestructurada.
...
\protect\phantomsection\label{_bookmark_P15_acta}{}\emph{\textbf{Tabla 23.25. Acta de Entrevista --- P15}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Ayuda a registrar datos básicos y lo indicado por el veterinario; combina computadora con cuadernos o formatos físicos.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Encontrar toda la información rápidamente es difícil; a veces debe preguntar al veterinario dónde quedó registrado un dato.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisa qué servicios, medicamentos o productos recibió la mascota para el cobro; los errores aparecen al revisar manualmente varios ítems.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisión física de productos y cantidades; las fechas de vencimiento a veces quedan cerca sin detectarse a tiempo.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
Ocurre algunas veces; se intenta recordar por mensaje o llamada; afecta la organización del día.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
WhatsApp o llamadas; ayuda a recordar citas y comunicar información indicada por el veterinario, pero las recomendaciones clínicas las responde el profesional.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Toma el peso y registra datos en cada visita; presta atención a la condición corporal (estudia zootecnia); necesita el historial de consultas previas para comparar.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas comunes sobre alimentación; orienta en aspectos generales y deriva dietas terapéuticas o casos de enfermedad al veterinario.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
No todos cumplen (olvidan horarios o suspenden al ver mejoría); se detecta en la siguiente consulta o en el seguimiento por mensaje/llamada.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Recopila información (medicamentos, dieta, síntomas, duración) y la comunica al veterinario; no cambia el tratamiento por su cuenta.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Usa un software veterinario completo con regularidad.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
...
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Útil para organizar información y mostrar alternativas, sin sustituir la revisión profesional.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada (siempre con revisión del veterinario; como auxiliar no sustituiría una indicación profesional).
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Respaldo en literatura científica validada y que el veterinario pueda revisar y corregir las sugerencias.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Facilitar encontrar información de pacientes y organizar las tareas diarias (citas, tratamientos, controles pendientes).
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Sencilla, rápida y fácil de aprender; que funcione en computadora y celular, con pocos pasos y soporte técnico.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Computadora/laptop principalmente.
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
...
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Organizar también las tareas del personal auxiliar (limpieza, preparación de áreas, insumos), no solo la información médica; dejar claro qué puede registrar un auxiliar frente a las decisiones exclusivas del veterinario.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P15_hallazgos}{}\emph{\textbf{Tabla 23.26. Acta de Entrevista P15 --- hallazgos}}

\subparagraph{Acta de Entrevista --- P16}\label{acta-entrevista-p16}
...
\protect\phantomsection\label{_bookmark_P16_acta}{}\emph{\textbf{Tabla 23.27. Acta de Entrevista --- P16}}
...
A1 & \textbf{Obtención de información clínica} &
\begin{minipage}[t]{\linewidth}\raggedright
Historias clínicas en cuadernos físicos, parcialmente migradas a Excel por la doctora principal de la clínica; cada consulta toma de 10 a 15 minutos por la reescritura de datos.
\end{minipage} \\
\hline
A2 & \textbf{Dificultades con el historial} &
\begin{minipage}[t]{\linewidth}\raggedright
Es difícil encontrar historias cuando el dueño o el personal olvida anotar datos; en urgencias esto genera demoras riesgosas si quien registró la última consulta no está presente.
\end{minipage} \\
\hline
A3 & \textbf{Proceso de cobro y facturación} &
\begin{minipage}[t]{\linewidth}\raggedright
El cobro se gestiona aparte de las fichas clínicas; ocurren errores por servicios no cobrados o cobrados por error; el proceso completo toma de 5 a 10 minutos por cliente.
\end{minipage} \\
\hline
A4 & \textbf{Control de inventario} &
\begin{minipage}[t]{\linewidth}\raggedright
Revisión manual semanal del inventario; han tenido medicamentos vencidos sin ninguna alerta que avise qué producto falta o venció.
\end{minipage} \\
\hline
A5 & \textbf{Inasistencias} &
\begin{minipage}[t]{\linewidth}\raggedright
De 2 a 3 cancelaciones sin aviso por semana; no usan recordatorio automático, solo mensajes.
\end{minipage} \\
\hline
A6 & \textbf{Comunicación post-consulta} &
\begin{minipage}[t]{\linewidth}\raggedright
Comunicación por WhatsApp personal de cada doctor con los dueños, lo que consume tiempo incluso fuera del horario laboral.
\end{minipage} \\
\hline
B1 & \textbf{Seguimiento nutricional} &
\begin{minipage}[t]{\linewidth}\raggedright
Registro en fichas físicas por consulta, sin una forma fácil de digitalizar o comparar los datos.
\end{minipage} \\
\hline
B2 & \textbf{Consultas sobre alimentación} &
\begin{minipage}[t]{\linewidth}\raggedright
Consultas semanales sobre alimentación; los dueños a veces citan fuentes no confiables (buscadores o IA genérica) en lugar de consultar al veterinario.
\end{minipage} \\
\hline
B3 & \textbf{Cumplimiento de indicaciones} &
\begin{minipage}[t]{\linewidth}\raggedright
El cumplimiento depende de la responsabilidad del dueño; se enteran si el paciente regresa o si el dueño llama preguntando por los síntomas.
\end{minipage} \\
\hline
B4 & \textbf{Ajuste sin ver al animal} &
\begin{minipage}[t]{\linewidth}\raggedright
Pide una descripción de los síntomas y fotos de referencia, pero de igual forma solicita que regrese a consulta presencial.
\end{minipage} \\
\hline
C1 & \textbf{Herramientas digitales} &
\begin{minipage}[t]{\linewidth}\raggedright
Uso de herramientas básicas (hojas de cálculo, WhatsApp, agenda digital); nada avanzado.
\end{minipage} \\
\hline
C2 & \textbf{Acuerdo con diagnóstico por IA} &
\begin{minipage}[t]{\linewidth}\raggedright
4/5 — confía en que se detecten patrones, pero la decisión final debe ser del especialista.
\end{minipage} \\
\hline
C3 & \textbf{Mayor carga de trabajo} &
\begin{minipage}[t]{\linewidth}\raggedright
Buscar historias clínicas y la doble anotación de datos genera más carga, sobre todo con varios pacientes esperando.
\end{minipage} \\
\hline
C4 & \textbf{Nivel de confianza en IA} &
\begin{minipage}[t]{\linewidth}\raggedright
Confianza moderada (apoyo con validación propia, ya que no conocen a fondo el funcionamiento del sistema).
\end{minipage} \\
\hline
C5 & \textbf{Condición más importante para confiar} &
\begin{minipage}[t]{\linewidth}\raggedright
Que el veterinario pueda revisar y corregir las sugerencias, y que los datos de los pacientes no se compartan con terceros.
\end{minipage} \\
\hline
D1 & \textbf{Primer problema a resolver} &
\begin{minipage}[t]{\linewidth}\raggedright
Resolver el problema de las fichas clínicas: poder buscar por paciente sin depender de hojas sueltas ni de la memoria de quien atendió la última vez.
\end{minipage} \\
\hline
D2 & \textbf{Características indispensables} &
\begin{minipage}[t]{\linewidth}\raggedright
Rapidez, acceso desde el celular y poca capacitación, dada la alta rotación de personal.
\end{minipage} \\
\hline
D3 & \textbf{Dispositivo preferido} &
\begin{minipage}[t]{\linewidth}\raggedright
Cualquier dispositivo indistintamente (computadora, tablet o móvil).
\end{minipage} \\
\hline
D4 & \textbf{Problemas de conectividad} &
\begin{minipage}[t]{\linewidth}\raggedright
3/5 (fallas ocasionales, a veces por cortes de luz).
\end{minipage} \\
\hline
D5 & \textbf{Necesidades no abordadas} &
\begin{minipage}[t]{\linewidth}\raggedright
Alertas de refuerzo de vacunas: actualmente depende solo de la memoria del dueño, y han llegado mascotas con vacunas atrasadas sin que nadie lo detectara a tiempo.
\end{minipage} \\
\hline
\end{longtable}
}

\protect\phantomsection\label{_bookmark_P16_hallazgos}{}\emph{\textbf{Tabla 23.28. Acta de Entrevista P16 --- hallazgos}}
...
\end{minipage} & 28 & RF-01 a RF-28 & Sección 3.2 \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Requisito No Funcional (RNF)
\end{minipage} & 21 & RNF-01 a RNF-21 & Sección 3.3 \\
\hline
Restricción (RST) & 10 & RST-01 a RST-10 & Secciones 2.6 / 3.4 \\
\hline
...
\hline
\endlastfoot
RST-01 & El sistema debe contemplar un modelo de costos accesible para
clínicas de 1 a 3 veterinarios, priorizando frameworks, bibliotecas y
servicios de bajo costo o de código abierto. & \begin{minipage}[t]{\linewidth}\raggedright
Presupuestaria
\end{minipage} \\
\hline
RST-02 & El sistema debe diseñarse con una arquitectura que permita su
consumo equivalente desde aplicaciones móviles (Android/iOS) y desde
navegador de escritorio. & \begin{minipage}[t]{\linewidth}\raggedright
Tecnológica
\end{minipage} \\
\hline
RST-03 & El módulo de sincronización offline debe implementarse
mediante una cola local de operaciones pendientes, evitando una
réplica completa de la base de datos en el cliente. & \begin{minipage}[t]{\linewidth}\raggedright
Técnica / Hardware
\end{minipage} \\
\hline
RST-04 & El módulo de Inteligencia Artificial debe implementarse como
un componente desacoplado del backend transaccional principal. & \begin{minipage}[t]{\linewidth}\raggedright
Arquitectónica
\end{minipage} \\
\hline
RST-05 & Toda sugerencia generada por el módulo de IA debe quedar
sujeta a revisión y aprobación explícita del veterinario antes de
incorporarse al historial clínico. & \begin{minipage}[t]{\linewidth}\raggedright
Ética / Regulatoria
\end{minipage} \\
\hline
RST-06 & El sistema debe implementar control de acceso basado en
roles (RBAC), restringiendo cada módulo según el perfil del usuario
autenticado. & \begin{minipage}[t]{\linewidth}\raggedright
Seguridad
\end{minipage} \\
\hline
RST-07 & El registro de auditoría de los historiales clínicos
(usuario, fecha, descripción del cambio) no debe permitir edición ni
eliminación retroactiva. & \begin{minipage}[t]{\linewidth}\raggedright
Seguridad
\end{minipage} \\
\hline
RST-08 & El sistema no debe emitir diagnósticos definitivos ni
prescripciones automatizadas de medicamentos; toda salida del módulo
de IA es una sugerencia sujeta a decisión del veterinario. & \begin{minipage}[t]{\linewidth}\raggedright
Regulatoria / Alcance
\end{minipage} \\
\hline
RST-09 & El sistema no debe integrarse con sistemas gubernamentales
de salud animal ni emitir facturación electrónica certificada ante el
SRI en la versión 1.0. & \begin{minipage}[t]{\linewidth}\raggedright
Regulatoria / Alcance
\end{minipage} \\
\hline
RST-10 & El equipo responsable del tratamiento debe evaluar, conforme
al Art. 48 de la LOPDP, la designación de un Delegado de Protección de
Datos Personales si el volumen o la sensibilidad de los datos lo
amerita. & \begin{minipage}[t]{\linewidth}\raggedright
Regulatoria
\end{minipage} \\
\hline
\end{longtable}
...
veterinarias entrevistadas (P01 y P02), es decir, los que
...
explicables para el veterinario (RNF-18), ya que sin estas condiciones
...
\begin{itemize}
\item
  EV-01: Entrevista a P01 responsable de la clínica (24/05/2026).
\item
  EV-02: Entrevista a P02, Médico Veterinario / Personal Clínico
  (25/05/2026).
\item
...
Sobre el total de 28 RF formalizados, la cobertura de trazabilidad es
del 100\%.

Cobertura requisito → caso de uso: 23/23 RF de campo (100\%) se vinculan
a un caso de uso. Evidencia más utilizada: EV-02 (entrevista a P02)
sustenta 14 de 23 RF; EV-01 (entrevista a P01) sustenta 12 de 23 RF.
...
completa (87 filas) reside también como archivo fuente en
...
\hline
TR-33 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo & EV-02 \\
\hline
TR-34 & ISO/IEC 25010 & — & OE-03 & Personal administrativo & EV-02 \\
\hline
TR-35 & ISO/IEC 25010 & — & OE-03 & Personal administrativo & EV-01,EV-02 \\
\hline
TR-36 & ISO/IEC 25010 & — & OE-01 & Médico veterinario & EV-01,EV-02 \\
\hline
TR-37 & LOPDP + ISO/IEC 25010 & Art. 4 & Transversal (OE-01/02/03) & Equipo de desarrollo & EV-01,EV-02 \\
\hline
TR-38 & LOPDP & Art. 4 & OE-01 & Médico veterinario & EV-01,EV-02 \\
\hline
TR-39 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Personal administrativo & EV-01,EV-02 \\
\hline
TR-40 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo & EV-01,EV-02 \\
\hline
TR-41 & ISO/IEC 25010 + LOPDP & Art. 25/26/30/31 & OE-02 & Médico veterinario & EV-01,EV-02 \\
\hline
...
\hline
TR-44 & ISO/IEC 25010 + LOPDP & Art. 25/26/30/31, Art. 37/39 & Transversal (OE-01/02/03) & Equipo de desarrollo & EV-02 \\
\hline
TR-45 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo & EV-14,EV-16 \\
\hline
TR-46 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Equipo de desarrollo & — \\
\hline
TR-47 & ISO/IEC 25010 & — & Transversal (OE-01/02/03) & Personal administrativo & EV-07,EV-13,EV-18 \\
\hline
...
\hline
TR-50 & LOPDP & Art. 20 & OE-02 & Médico veterinario & EV-01,EV-02 \\
\hline
TR-51 & — & — & Transversal & Equipo de desarrollo & EV-01 \\
\hline
TR-52 & — & — & Transversal & Equipo de desarrollo & EV-05,EV-18 \\
\hline
TR-53 & — & — & Transversal & Equipo de desarrollo & EV-15,EV-16 \\
\hline
TR-54 & — & — & OE-02 & Equipo de desarrollo & — \\
\hline
TR-55 & LOPDP & Art. 20 & OE-02 & Equipo de desarrollo & EV-01,EV-14,EV-17 \\
\hline
TR-56 & — & — & Transversal & Equipo de desarrollo & EV-14,EV-16 \\
\hline
TR-57 & LOPDP & Art. 4 & OE-01 & Equipo de desarrollo & EV-12 \\
\hline
TR-58 & LOPDP & Art. 20 & OE-02 & Equipo de desarrollo & EV-01,EV-02,EV-13 \\
\hline
...
\hline
TR-61 & — & — & OE-02 & Equipo de desarrollo & — \\
\hline
TR-62 & — & — & OE-02 & Equipo de desarrollo & — \\
\hline
TR-63 & — & RST-05, RST-08 (supervisión humana) & OE-02 & Médico veterinario & EV-01,EV-02 \\
\hline
TR-64 & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario & — \\
\hline
TR-65 & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario & — \\
\hline
TR-66 & — & — & Transversal (OE-01/02/03) & Personal administrativo / Veterinario / Propietario & — \\
\hline
TR-67 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-68 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-69 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-70 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-71 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-72 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-73 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-74 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-75 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-76 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-77 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-78 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-79 & — & — & OE-02 & Médico veterinario & — \\
\hline
TR-80 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-81 & — & — & OE-01 & Médico veterinario & — \\
\hline
TR-82 & — & — & OE-03 & Propietario de la mascota & — \\
\hline
TR-83 & — & — & OE-03 & Propietario de la mascota & — \\
\hline
TR-84 & — & — & OE-03 & Personal administrativo / Bodeguero & — \\
\hline
TR-85 & — & — & OE-03 & Personal administrativo / Bodeguero & — \\
\hline
TR-86 & — & — & OE-03 & Personal administrativo & — \\
\hline
TR-87 & — & — & OE-03 & Personal administrativo & — \\\end{longtable}
}

\protect\phantomsection\label{_bookmarkD1}{}\emph{\textbf{Tabla D.1. Matriz de Trazabilidad Extendida --- Identificación normativa y objetivo (87 filas)}}
...
\hline
\endlastfoot
TR-01 & RF-01 & CU-01 & HU-01 & CA-01 & Frontend Web/Móvil & Transversal \\
\hline
TR-02 & RF-02 & CU-03 & HU-02 & CA-02 & Backend Historiales Clínicos & MU-005\_Ficha\_Paciente \\
\hline
TR-03 & RF-02 & CU-03 & HU-02 & CA-02 & Backend Historiales Clínicos & MU-005\_Ficha\_Paciente \\
\hline
TR-04 & RF-03 & CU-03 & HU-03 & CA-03 & Backend Historiales Clínicos & MU-003\_Buscar\_Paciente \\
\hline
TR-05 & RF-04 & CU-02 & HU-04 & CA-04 & Backend Historiales Clínicos & MU-006\_Registrar\_Consulta \\
\hline
TR-06 & RF-05 & CU-04 & HU-05 & CA-05 & Backend Inventario & MU-015\_Alerta\_De\_Inventario \\
\hline
TR-07 & RF-06 & CU-04 & HU-06 & CA-06 & Backend Inventario & MU-024\_Gestion\_Stock \\
\hline
TR-08 & RF-06 & CU-04 & HU-06 & CA-06 & Backend Inventario & MU-024\_Gestion\_Stock \\
\hline
TR-09 & RF-07 & CU-10 & HU-07 & CA-07 & Backend Facturación & MU-026\_Registro\_De\_Cobro \\
\hline
TR-10 & RF-08 & CU-10 & HU-08 & CA-08 & Backend Facturación & MU-027\_Facturacion\_Datos\_Del\_Receptor,MU-028\_Facturacion\_Servicios\_Montos,MU-029\_Confirmar\_Emitir,MU-030\_Facturacion\_Emitida \\
\hline
TR-11 & RF-09 & CU-08 & HU-09 & CA-09 & Módulo Comunicaciones & MU-016\_Comunicaciones \\
\hline
TR-12 & RF-10 & CU-08 & HU-10 & CA-10 & Módulo Comunicaciones & MU-018\_Envio\_Por\_WhatsApp \\
\hline
TR-13 & RF-11 & CU-09 & HU-11 & CA-11 & Módulo Citas y Recordatorios & MU-013\_Registrar\_Citas \\
\hline
TR-14 & RF-11 & CU-09 & HU-11 & CA-11 & Módulo Citas y Recordatorios & MU-013\_Registrar\_Citas \\
\hline
TR-15 & RF-12 & CU-09 & HU-22 — Como propietario de la mascota, quiero recibir un recordatorio automático 24 horas antes de mi cita, para no olvidar la consulta programada. & El recordatorio se envía automáticamente 24 horas antes de la cita, sin intervención manual. & Módulo Citas y Recordatorios & MU-031\_Recordatorios\_De\_Citas \\
\hline
TR-16 & RF-13 & CU-07 & HU-12 & CA-12 & Backend Seguimiento Nutricional & MU-011\_Seguimiento\_De\_Peso \\
\hline
TR-17 & RF-14 & CU-07 & HU-23 — Como médico veterinario, quiero recibir recomendaciones nutricionales automáticas basadas en el peso y condición del paciente, para orientar mejor al propietario sobre su alimentación. & La recomendación se actualiza automáticamente al registrarse un nuevo dato de peso o condición corporal (RF-13). & Backend Seguimiento Nutricional & MU-019\_Recomendaciones\_Nutricionales \\
\hline
TR-18 & RF-15 & CU-09 & HU-24 — Como médico veterinario, quiero programar recordatorios de seguimiento de indicaciones médicas, para verificar que el propietario cumpla con el tratamiento indicado. & El veterinario puede programar un recordatorio con fecha y descripción el sistema notifica al personal en la fecha establecida. & Módulo Citas y Recordatorios & MU-020\_Recordatorios\_Medicos \\
\hline
TR-19 & RF-16 & CU-03 & HU-25 — Como médico veterinario, quiero exportar el historial clínico del paciente en PDF, para remitirlo a clínicas con mayor equipamiento cuando sea necesario. & El sistema genera un PDF con el historial clínico completo del paciente, descargable en menos de 5 segundos. & Backend Historiales Clínicos & MU-021\_Exportar\_Reportes \\
\hline
TR-20 & RF-17 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-21 & RF-17 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-22 & RF-18 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-23 & RF-18 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-24 & RF-19 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-25 & RF-20 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil & Transversal \\
\hline
TR-26 & RF-21 & Transversal & HU-26 — Como médico veterinario, quiero seguir registrando y consultando historiales clínicos aunque no haya conexión a internet, para no interrumpir la atención durante cortes de conectividad. & El registro y consulta permanecen disponibles sin conexión la sincronización se completa según RNF-04 al restablecerse la conectividad. & Infraestructura/Backend & Transversal \\
\hline
TR-27 & RF-22 & CU-01 & HU-19 & CA-19 & Módulo Autenticación/Usuarios & MU-001\_Login \\
\hline
TR-28 & RF-23 & CU-03 & HU-27 — Como administrador del sistema, quiero que cada modificación a un historial clínico quede registrada con usuario, fecha y descripción, para auditar cambios y cumplir con la trazabilidad exigida por la LOPDP. & Toda modificación genera un registro de auditoría (usuario, fecha, descripción) que no puede editarse ni eliminarse retroactivamente, conforme a RNF-06. & Backend Historiales Clínicos & MU-032\_Log\_De\_Auditoria \\
\hline
TR-29 & RF-24 & CU-01 & HU-20 & CA-20 & Módulo Autenticación/Usuarios & MU-001\_Login \\
\hline
TR-30 & RF-25 & Transversal & HU-21 & CA-21 & Backend Reportes & MU-033\_Reportes\_Gerenciales \\
\hline
TR-31 & RF-26 & Transversal & HU-14 & CA-14 & Módulo Legal/Consentimiento & Falta crear (no existe en el catálogo de 33 MU) \\
\hline
TR-32 & RF-27 & Transversal & HU-15 & CA-15 & Módulo Legal/Consentimiento & Falta crear (no existe en el catálogo de 33 MU) \\
\hline
TR-33 & RNF-01 & CU-03 & HU-03 & CA-03 & Backend Historiales Clínicos & MU-003\_Buscar\_Paciente \\
\hline
TR-34 & RNF-02 & CU-10 & HU-08 & CA-08 & Backend Facturación & MU-027\_Facturacion\_Datos\_Del\_Receptor,MU-028\_Facturacion\_Servicios\_Montos,MU-029\_Confirmar\_Emitir,MU-030\_Facturacion\_Emitida \\
\hline
TR-35 & RNF-03 & CU-04 & HU-05 & CA-05 & Backend Inventario & MU-015\_Alerta\_De\_Inventario \\
\hline
TR-36 & RNF-04 & CU-03 & HU-26 & CA-26 & Backend Historiales Clínicos & Transversal \\
\hline
TR-37 & RNF-05 & CU-01 & HU-20 & CA-20 & Módulo Autenticación/Usuarios & MU-001\_Login \\
\hline
TR-38 & RNF-06 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos & MU-032\_Log\_De\_Auditoria \\
\hline
TR-39 & RNF-07 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil & Transversal \\
\hline
TR-40 & RNF-08 & Transversal & HU-01 & CA-01 & Frontend Web/Móvil & Transversal \\
\hline
TR-41 & RNF-09 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-42 & RNF-10 & CU-06 & — & — & Módulo IA Diagnóstico & No aplica \\
\hline
TR-43 & RNF-11 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-44 & RNF-12 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-45 & RNF-13 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-46 & RNF-14 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-47 & RNF-15 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil & Transversal \\
\hline
TR-48 & RNF-16 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-49 & RNF-17 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-50 & RNF-18 & CU-06 & HU-16 & CA-31 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-51 & RST-01 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-52 & RST-02 & CU-01 & HU-01 & CA-01 & Módulo Autenticación/Usuarios & Transversal \\
\hline
TR-53 & RST-03 & Transversal & HU-26 & CA-26 & Infraestructura/Backend & No aplica \\
\hline
TR-54 & RST-04 & CU-06 & — & — & Módulo IA Diagnóstico & No aplica \\
\hline
TR-55 & RST-05 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-56 & RST-06 & CU-01 & HU-19 & CA-19 & Módulo Autenticación/Usuarios & MU-001\_Login \\
\hline
TR-57 & RST-07 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos & MU-032\_Log\_De\_Auditoria \\
\hline
TR-58 & RST-08 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-59 & RST-09 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-60 & RST-10 & Transversal & — & — & Infraestructura/Backend & No aplica \\
\hline
TR-61 & RNF-19 & CU-06 & HU-28 & CA-28 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-62 & RNF-20 & CU-06 & HU-29 & CA-29 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-63 & RNF-21 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico & MU-010\_Sugerencia\_IA \\
\hline
TR-64 & N/A (evento de flujo) & CU-01 & — & — & Módulo Autenticación/Usuarios & — \\
\hline
TR-65 & N/A (evento de flujo) & CU-01 & — & — & Módulo Autenticación/Usuarios & — \\
...
TR-86 & RF-08 & CU-10 & — & — & Backend Facturación & — \\
\hline
TR-87 & RF-08 & CU-10 & — & — & Backend Facturación & — \\\end{longtable}
}

\protect\phantomsection\label{_bookmarkD2}{}\emph{\textbf{Tabla D.2. Matriz de Trazabilidad Extendida --- Diseño, historias de usuario y mockup asociado (87 filas)}}

\subsubsection{D.3 Resumen de cobertura}\label{d3-resumen-cobertura}

\begin{itemize}
  \item \textbf{Total de filas cerradas:} 87 (TR-01 a TR-87), cumpliendo el mínimo exigido por la guía de Entrega 4 (2B).
  \item \textbf{Requisitos funcionales trazados:} RF-01 a RF-28.
  \item \textbf{Requisitos no funcionales trazados:} RNF-01 a RNF-21 (ISO/IEC 25010:2023).
  \item \textbf{Restricciones de diseño trazadas:} RST-01 a RST-10.
  \item \textbf{Módulo con mayor densidad normativa (LOPDP):} Módulo IA Diagnóstico (RF-17, RF-18, RF-19, RNF-09, RNF-10, RNF-18, RNF-19, RNF-20, RNF-21, RST-04, RST-05, RST-08), consistente con el Enfoque 3 (explicabilidad) del componente empírico del proyecto.
...
\url{https://github.com/gleiston-guerrero/SGCV-IA}

\vspace{0.2cm}
\noindent\fbox{\parbox{0.97\textwidth}{\small
\textbf{Archivos raíz.} Se confirma la presencia de
\texttt{README.md}, \texttt{CHANGELOG.md}, \texttt{LICENSE},
\texttt{CITATION.cff} y \texttt{checksums.sha256} en la raíz del
repositorio. El archivo \texttt{CHANGELOG.md} registra las
incorporaciones de RF-26, RF-27, RNF-19 y RNF-21 derivadas del
análisis de cumplimiento legal (Criterio C4).
}}
\vspace{0.3cm}
...
\noindent\fbox{\parbox{0.97\textwidth}{\footnotesize\textbf{Nota sobre los
...
empírico} desde \texttt{07\_Datos/scripts/}:
\begin{verbatim}
Rscript run_all.R
\end{verbatim}
...
en Buff Note.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A2 --- derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-04}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A4 --- derivado — sin cita verificable de entrevista (P01); necesidad identificada por el equipo durante el análisis de A1–A6; A4 --- P02 ("manualmente revisando uno a uno")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-06}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A3 --- P04 ("es la parte más demorada")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-09}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A6 --- derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-11}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
A5 --- P04 ("no sabemos qué pasó con el paciente")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-12}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B1 --- P05 ("en base a la edad va a agarrar el peso"); B1 --- P02
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-14}
...
veterinario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B2 --- derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-15}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B3 --- derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-16}
...
equipamiento.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
B4 --- derivado — sin cita verificable de entrevista; necesidad identificada por el equipo durante el análisis de A1–A6
\end{minipage} & Should \\
\hline
\multicolumn{5}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.9603} + 8\tabcolsep}@{}}{%
...
del veterinario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
C2/C4 --- P02 ("confianza moderada... viendo al paciente, viendo en directo"); C4 --- P01 ("revisar el texto recomendacional... revisar y corregir las sugerencias antes")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-18}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
C5 --- P10, P11, P14, P15 (opción literatura científica validada); P01 no consultado, P02 no identificable (ver RC-18)
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-19}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
C5 --- P07, P10, P11, P13, P14 (opción revisión/corrección veterinaria); P01 no consultado, P02 no identificable (ver RC-19)
\end{minipage} & \textbf{Must} \\
\hline
\multicolumn{5}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.9603} + 8\tabcolsep}@{}}{%
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
D2 --- P01 ("que sea fácil de usar"); D2 --- P04 ("facilidad de utilizarla")
\end{minipage} & \textbf{Must} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\textbf{RC-21}
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
D4 --- P01 (nivel 2-3/5 de cortes); D4 --- P02 (nivel 1-2/5, rara vez,
pero ocurre)
\end{minipage} & Should \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
...
\item
  ...
  nombre del animal, problema específico identificado por P02 con
  Buff Note.
\item
  ...
  pasos basado en el dolor específico de P02.
\item
  RC-10 (NUEVO): Envío de resultados por WhatsApp; necesidad identificada por el equipo, sin cita verificable de entrevista.
\item
...
\item
  ...
  Must) porque P02 reportó baja frecuencia de cortes (nivel 1-2/5),
  frente a un nivel 2-3/5 reportado por P01.
\item
  RC-22 (NUEVO): El bajo costo fue mencionado explícitamente como
  criterio de adopción por P01; se eleva a Must.
\item
