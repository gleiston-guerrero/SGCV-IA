...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
RC-25 --- Entrevista P12 (``también debería tener permisos por usuario y respaldo de la información''). El componente de asignación de permisos está evidenciado directamente; el restablecimiento de contraseñas y la edición de datos del empleado son una necesidad operativa complementaria identificada por el equipo de desarrollo, no mencionada explícitamente en las entrevistas.
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
\url{https://github.com/ramaguas-ship-it/SGCV-IA/releases/download/untagged-540381af922d29d52516/Demo.SGCV-IA.mp4}
