...
\hyperref[_bookmarkD1]{Tabla D.1. Matriz de Trazabilidad Extendida --- Identificación normativa y objetivo (63 filas)}

\hyperref[_bookmarkD2]{Tabla D.2. Matriz de Trazabilidad Extendida --- Diseño, historias de usuario y mockup asociado (63 filas)}
...
\hline
\textbf{Fuente} & \begin{minipage}[t]{\linewidth}\raggedright
[PENDIENTE — completar con la entrevista/RC real del equipo que sustenta este requisito. No coloquen una cita inventada; si no encuentran una entrevista que lo respalde directamente, indíquenlo como "necesidad operativa identificada por el equipo de desarrollo" en vez de atribuirlo a un participante que no lo mencionó.]
\end{minipage} \\
\hline
\textbf{Entradas / Salidas} & \begin{minipage}[t]{\linewidth}\raggedright
...
en el documento: 27 Requisitos Funcionales (RF), 21 Requisitos No
Funcionales (RNF), 10 Restricciones (RST) y 14 Requisitos Legales (RL),
para un total de 72 elementos clasificados.
\end{quote}
...
\hline
\endlastfoot
Requisito Funcional (RF) & 27 & RF-01 a RF-27 \\
\hline
...
\textbf{Resumen cuantitativo (RF):} 21 Must (78\%), 5 Should (18\%), 1
...
legibilidad, cubriendo el total de 63 filas de trazabilidad (TR-01 a
TR-63), correspondientes a 27 RF, 21 RNF y 10 RST, sobre el
...
\hline
TR-30 (RF-25) & RF & — & — & OE-03 & \begin{minipage}[t]{\linewidth}\raggedright
Propietario o administrador de la clínica
\end{minipage} \\
\hline
...
\hline
TR-48 (RNF-16) & RNF & LOPDP & Art. 10 lit. i) & Transversal (LOPDP) & \begin{minipage}[t]{\linewidth}\raggedright
Comité de ética / protección de datos (LOPDP)
\end{minipage} \\
\hline
TR-49 (RNF-17) & RNF & LOPDP & Art. 43, 46 & Transversal (LOPDP) & \begin{minipage}[t]{\linewidth}\raggedright
Comité de ética / protección de datos (LOPDP)
\end{minipage} \\
\hline
...
\hline
TR-60 (RST-10) & RST & LOPDP & Art. 47, 48 & Transversal (LOPDP) & \begin{minipage}[t]{\linewidth}\raggedright
Comité de ética / protección de datos (LOPDP)
\end{minipage} \\
\hline
TR-61 (RNF-19) & RNF & — & — & OE-02 & Médico veterinario \\
\hline
TR-62 (RNF-20) & RNF & — & — & OE-02 & Equipo de desarrollo \\
\hline
TR-63 (RNF-21) & RNF & — & \begin{minipage}[t]{\linewidth}\raggedright
RST-05, RST-08 (supervisión humana)
\end{minipage} & OE-02 & Médico veterinario \\
\hline
\end{longtable}
}
...
\hline
TR-15 (RF-12) & EV-02 & CU-09 & \begin{minipage}[t]{\linewidth}\raggedright
HU-22 — Como propietario de la mascota, quiero recibir un recordatorio automático 24 horas antes de mi cita, para no olvidar la consulta programada.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
El recordatorio se envía automáticamente 24 horas antes de la cita, sin intervención manual.
\end{minipage} & Módulo Citas y Recordatorios \\
\hline
TR-16 (RF-13) & EV-01 & CU-07 & HU-12 & CA-12 & \begin{minipage}[t]{\linewidth}\raggedright
Backend Seguimiento Nutricional
\end{minipage} \\
\hline
TR-17 (RF-14) & EV-01 & CU-07 & \begin{minipage}[t]{\linewidth}\raggedright
HU-23 — Como médico veterinario, quiero recibir recomendaciones nutricionales automáticas basadas en el peso y condición del paciente, para orientar mejor al propietario sobre su alimentación.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
La recomendación se actualiza automáticamente al registrarse un nuevo dato de peso o condición corporal (RF-13).
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
...
\end{minipage} \\
\hline
TR-18 (RF-15) & EV-02 & CU-09 & \begin{minipage}[t]{\linewidth}\raggedright
HU-24 — Como médico veterinario, quiero programar recordatorios de seguimiento de indicaciones médicas, para verificar que el propietario cumpla con el tratamiento indicado.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
El veterinario puede programar un recordatorio con fecha y descripción el sistema notifica al personal en la fecha establecida.
\end{minipage} & Módulo Citas y Recordatorios \\
\hline
TR-19 (RF-16) & EV-01 & CU-03 & \begin{minipage}[t]{\linewidth}\raggedright
HU-25 — Como médico veterinario, quiero exportar el historial clínico del paciente en PDF, para remitirlo a clínicas con mayor equipamiento cuando sea necesario.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
El sistema genera un PDF con el historial clínico completo del paciente, descargable en menos de 5 segundos.
\end{minipage} & Backend Historiales Clínicos \\
\hline
...
\hline
TR-26 (RF-21) & EV-01,EV-02 & Transversal & \begin{minipage}[t]{\linewidth}\raggedright
HU-26 — Como médico veterinario, quiero seguir registrando y consultando historiales clínicos aunque no haya conexión a internet, para no interrumpir la atención durante cortes de conectividad.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
El registro y consulta permanecen disponibles sin conexión la sincronización se completa según RNF-04 al restablecerse la conectividad.
\end{minipage} & Infraestructura/Backend \\
\hline
TR-27 (RF-22) & EV-01,EV-02 & CU-01 & HU-19 & CA-19 & \begin{minipage}[t]{\linewidth}\raggedright
Módulo Autenticación/Usuarios
\end{minipage} \\
\hline
TR-28 (RF-23) & EV-02 & CU-03 & \begin{minipage}[t]{\linewidth}\raggedright
HU-27 — Como administrador del sistema, quiero que cada modificación a un historial clínico quede registrada con usuario, fecha y descripción, para auditar cambios y cumplir con la trazabilidad exigida por la LOPDP.
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Toda modificación genera un registro de auditoría (usuario, fecha, descripción) que no puede editarse ni eliminarse retroactivamente, conforme a RNF-06.
\end{minipage} & Backend Historiales Clínicos \\
\hline
TR-29 (RF-24) & EV-04 & CU-01 & HU-20 & CA-20 & \begin{minipage}[t]{\linewidth}\raggedright
Módulo Autenticación/Usuarios
\end{minipage} \\
\hline
...
\hline
TR-37 (RNF-05) & EV-01,EV-02 & CU-01 & HU-20 & CA-20 & \begin{minipage}[t]{\linewidth}\raggedright
Módulo Autenticación/Usuarios
\end{minipage} \\
\hline
...
\hline
TR-52 (RST-02) & EV-05,EV-18 & CU-01 & HU-01 & CA-01 & \begin{minipage}[t]{\linewidth}\raggedright
Módulo Autenticación/Usuarios
\end{minipage} \\
\hline
...
\hline
TR-56 (RST-06) & EV-14,EV-16 & CU-01 & HU-19 & CA-19 & \begin{minipage}[t]{\linewidth}\raggedright
Módulo Autenticación/Usuarios
\end{minipage} \\
\hline
...
\hline
TR-05 (RF-04) & \begin{minipage}[t]{\linewidth}\raggedright
MU-006\_Registrar\_Consulta
\end{minipage} \\
\hline
TR-06 (RF-05) & \begin{minipage}[t]{\linewidth}\raggedright
MU-015\_Alerta\_De\_Inventario
\end{minipage} \\
\hline
...
\hline
TR-09 (RF-07) & \begin{minipage}[t]{\linewidth}\raggedright
MU-026\_Registro\_De\_Cobro
\end{minipage} \\
\hline
TR-10 (RF-08) & \begin{minipage}[t]{\linewidth}\raggedright
MU-027\_Facturacion\_Datos\_Del\_Receptor,\\
MU-028\_Facturacion\_Servicios\_Montos,\\
MU-029\_Confirmar\_Emitir,\\
MU-030\_Facturacion\_Emitida
\end{minipage} \\
\hline
TR-11 (RF-09) & MU-016\_Comunicaciones \\
\hline
TR-12 (RF-10) & \begin{minipage}[t]{\linewidth}\raggedright
MU-018\_Envio\_Por\_WhatsApp
\end{minipage} \\
\hline
...
\hline
TR-15 (RF-12) & \begin{minipage}[t]{\linewidth}\raggedright
MU-031\_Recordatorios\_De\_Citas
\end{minipage} \\
\hline
TR-16 (RF-13) & \begin{minipage}[t]{\linewidth}\raggedright
MU-011\_Seguimiento\_De\_Peso
\end{minipage} \\
\hline
TR-17 (RF-14) & \begin{minipage}[t]{\linewidth}\raggedright
MU-019\_Recomendaciones\_Nutricionales
\end{minipage} \\
\hline
TR-18 (RF-15) & \begin{minipage}[t]{\linewidth}\raggedright
MU-020\_Recordatorios\_Medicos
\end{minipage} \\
\hline
TR-19 (RF-16) & \begin{minipage}[t]{\linewidth}\raggedright
MU-021\_Exportar\_Reportes
\end{minipage} \\
\hline
...
\hline
TR-28 (RF-23) & \begin{minipage}[t]{\linewidth}\raggedright
MU-032\_Log\_De\_Auditoria
\end{minipage} \\
\hline
TR-29 (RF-24) & MU-001\_Login \\
\hline
TR-30 (RF-25) & \begin{minipage}[t]{\linewidth}\raggedright
MU-033\_Reportes\_Gerenciales
\end{minipage} \\
\hline
TR-31 (RF-26) & \begin{minipage}[t]{\linewidth}\raggedright
Falta crear (no existe en el catálogo de 33 MU)
\end{minipage} \\
\hline
TR-32 (RF-27) & \begin{minipage}[t]{\linewidth}\raggedright
Falta crear (no existe en el catálogo de 33 MU)
\end{minipage} \\
\hline
TR-33 (RNF-01) & MU-003\_Buscar\_Paciente \\
\hline
TR-34 (RNF-02) & \begin{minipage}[t]{\linewidth}\raggedright
MU-027\_Facturacion\_Datos\_Del\_Receptor,\\
MU-028\_Facturacion\_Servicios\_Montos,\\
MU-029\_Confirmar\_Emitir,\\
MU-030\_Facturacion\_Emitida
\end{minipage} \\
\hline
TR-35 (RNF-03) & \begin{minipage}[t]{\linewidth}\raggedright
MU-015\_Alerta\_De\_Inventario
\end{minipage} \\
\hline
...
\hline
TR-38 (RNF-06) & \begin{minipage}[t]{\linewidth}\raggedright
MU-032\_Log\_De\_Auditoria
\end{minipage} \\
\hline
...
\hline
TR-57 (RST-07) & \begin{minipage}[t]{\linewidth}\raggedright
MU-032\_Log\_De\_Auditoria
\end{minipage} \\
\hline
...
RF-01 a RF-19: estimación confirmada por el equipo. RF-20 a RF-27:
...
\textbf{63 filas} (TR-01 a TR-63), enlazando Ley/Objetivo/Interesado/EV
...
\end{minipage} & 27 & RF-01 a RF-27 & Sección 3.2 \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
...
completa (63 filas) reside también como archivo fuente en
...
\hline
TR-61 & --- & --- & OE-02 & Médico veterinario & --- \\
\hline
TR-62 & --- & --- & OE-02 & Equipo de desarrollo & --- \\
\hline
TR-63 & --- & RST-05, RST-08 (supervisión humana) & OE-02 & Médico veterinario & EV-01,EV-02 \\\end{longtable}
}

\protect\phantomsection\label{_bookmarkD1}{}\emph{\textbf{Tabla D.1. Matriz de Trazabilidad Extendida --- Identificación normativa y objetivo (63 filas)}}
...
\hline
TR-33 & RNF-01 & CU-03 & HU-03 & CA-03 & Backend Historiales Clínicos & — \\
\hline
TR-34 & RNF-02 & CU-10 & HU-08 & CA-08 & Backend Facturación & — \\
\hline
TR-35 & RNF-03 & CU-04 & HU-05 & CA-05 & Backend Inventario & — \\
\hline
TR-36 & RNF-04 & CU-03 & HU-26 & CA-26 & Backend Historiales Clínicos & — \\
\hline
TR-37 & RNF-05 & CU-01 & HU-20 & CA-20 & Módulo Autenticación/Usuarios & — \\
\hline
TR-38 & RNF-06 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos & — \\
\hline
TR-39 & RNF-07 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil & — \\
\hline
TR-40 & RNF-08 & Transversal & HU-01 & CA-01 & Frontend Web/Móvil & — \\
\hline
TR-41 & RNF-09 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & — \\
\hline
TR-42 & RNF-10 & CU-06 & — & — & Módulo IA Diagnóstico & — \\
\hline
TR-43 & RNF-11 & Transversal & — & — & Infraestructura / Backend & — \\
...
TR-46 & RNF-14 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-47 & RNF-15 & Transversal & HU-18 & CA-18 & Frontend Web/Móvil & — \\
\hline
TR-48 & RNF-16 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-49 & RNF-17 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-50 & RNF-18 & CU-06 & HU-16 & CA-16 & Módulo IA Diagnóstico & — \\
\hline
TR-51 & RST-01 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-52 & RST-02 & CU-01 & HU-01 & CA-01 & Módulo Autenticación/Usuarios & — \\
\hline
TR-53 & RST-03 & Transversal & HU-26 & CA-26 & Infraestructura / Backend & — \\
\hline
TR-54 & RST-04 & CU-06 & — & — & Módulo IA Diagnóstico & — \\
\hline
TR-55 & RST-05 & CU-06 & HU-13 & CA-13 & Módulo IA Diagnóstico & — \\
\hline
TR-56 & RST-06 & CU-01 & HU-19 & CA-19 & Módulo Autenticación/Usuarios & — \\
\hline
TR-57 & RST-07 & CU-03 & HU-27 & CA-27 & Backend Historiales Clínicos & — \\
\hline
TR-58 & RST-08 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico & — \\
\hline
TR-59 & RST-09 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-60 & RST-10 & Transversal & — & — & Infraestructura / Backend & — \\
\hline
TR-61 & RNF-19 & CU-06 & HU-28 & CA-28 & Módulo IA Diagnóstico & Panel de Diagnóstico IA \\
\hline
TR-62 & RNF-20 & CU-06 & HU-29 & CA-29 & Módulo IA Diagnóstico & Panel de Diagnóstico IA \\
\hline
TR-63 & RNF-21 & CU-06 & HU-17 & CA-17 & Módulo IA Diagnóstico & Panel de Diagnóstico IA \\\end{longtable}
}

\protect\phantomsection\label{_bookmarkD2}{}\emph{\textbf{Tabla D.2. Matriz de Trazabilidad Extendida --- Diseño, historias de usuario y mockup asociado (63 filas)}}

\subsubsection{D.3 Resumen de cobertura}\label{d3-resumen-cobertura}

\begin{itemize}
  \item \textbf{Total de filas cerradas:} 63 (TR-01 a TR-63), cumpliendo el mínimo exigido por la guía de Entrega 4 (2B).
