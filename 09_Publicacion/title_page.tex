...
specific to this study. The project was classified as Category~B
(personal data, with an additional B1 requirement for host-organization
endorsement) under this course-level framework. Institutional
endorsement of the host-organization letter by the university's
Vicerrectorado Académico, required to formalize this classification,
had not been issued as of the submission date; this affected all
teams in the course uniformly and was not specific to this study.
...
responses for academic and research purposes. Only anonymized,
aggregated findings are disseminated in this manuscript; no
individually identifying information (names, signatures, or other
identifiers) is published. Materials that could identify participants
are retained separately in the restricted evidence area under
encryption and are not intended for public dissemination (see Data,
...
\href{https://doi.org/10.5281/zenodo.22558095}{https://doi.org/10.5281/zenodo.22558095}
(version 2.0, CC~BY~4.0). The protocol for the Enfoque 3 empirical
component is registered on OSF:
\href{https://osf.io/r5p8d/}{https://osf.io/r5p8d/} (registered
1 August 2026).
...
\textbf{Mesías Quijije, J.A.}: independent second-coder inter-rater
reliability analysis (Cohen's $\kappa$), ethics-documentation package,
ERS bibliography, walkthrough-validation evidence and minutes,
member-checking session materials, organizational i* modeling scripts,
field-notes reorganization.
\textbf{Barrionuevo Fuentes, C.D.}: construction and maintenance of the
statistical-analysis pipeline for the empirical component (data
import, cleaning, descriptive statistics, assumption checks,
hypothesis testing, effect-size estimation, figures and tables),
reproducible data pipeline for the anonymized dataset, final
resynchronization of results with the definitive sample (n=210).
