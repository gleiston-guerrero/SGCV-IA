...
- **[Sesion_1.md](Sesion_1.md):** Fecha, participantes, roles, tema tratado y enlace a la grabación de la primera sesión.
- **[Sesion_2.md](Sesion_2.md):** Fecha, participantes, roles, tema tratado y enlace a la grabación de la segunda sesión.
...
1. `Sesiones.md` — punto de entrada, resume qué hay en la carpeta.
2. `Sesion_1.md` — contexto completo de la primera sesión (asignación de tareas).
3. `Sesion_2.md` — contexto completo de la segunda sesión (avance de tareas).
